...
/**
 * Class m191108_071036_ecommerce_check_box
 */
class m191108_071036_ecommerce_check_box extends Migration
{
    public function up()
    {
        $tableOptions = null;
        ...
        $this->createTable('ecommerce_check_box', [
            'id' => $this->primaryKey(),
        ...
        $this->execute("ALTER TABLE `ecommerce_check_box`
...
ADD INDEX `place_address` (`place_address`);");
    ...
    {
        $this->dropTable('{{%ecommerce_check_box}}');
    }
}
