...
class m140930_060338_create_table_outbound_order_items extends Migration
{
    public function up()
    {
        $tableOptions = null;
        ...
        $this->createTable('{{%outbound_order_items}}', [
            'id' => Schema::TYPE_PK,
            'outbound_order_id' => Schema::TYPE_INTEGER . ' NOT NULL COMMENT "Internal outbound order id"',
    ...
    {
        $this->dropTable('{{%outbound_order_items}}');
    }
}