...
/**
 * Class m190914_101456_ecommerce_stock_adjustment_response
 */
class m190914_101456_ecommerce_stock_adjustment_response extends Migration
{
    public function up()
    {
        $tableOptions = null;
        ...
        $this->createTable('ecommerce_stock_adjustment_response', [
            'id' => $this->primaryKey(),
            'stock_adjustment_request_id' => $this->integer(11)->comment(''),
    ...
    {
        $this->dropTable('{{%ecommerce_stock_adjustment_response}}');
    }
}
