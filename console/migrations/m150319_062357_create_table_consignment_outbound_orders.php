...
class m150319_062357_create_table_consignment_outbound_orders extends Migration
{
    public function up()
    {
        $tableOptions = null;
        ...
        $this->createTable('{{%consignment_outbound_orders}}', [
            'id' => Schema::TYPE_PK,
    ...
    {
        $this->dropTable('{{%consignment_outbound_orders}}');
    }
}
