...
/**
 * Handles the creation for table `table_consignment_universal_orders`.
 */
class m160617_110319_create_table_consignment_universal_orders extends Migration
{
    /**
     * @inheritdoc
     */
    public function up()
    {
        ...
        $this->createTable('consignment_universal_orders', [
            'id' => $this->primaryKey(),
    ...
    {
        $this->dropTable('consignment_universal_orders');
    }
}