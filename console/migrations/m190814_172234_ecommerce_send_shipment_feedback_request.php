...
/**
 * Class m190814_172234_ecommerce_send_shipment_feedback_request
 */
class m190814_172234_ecommerce_send_shipment_feedback_request extends Migration
{
    public function up()
    {
        $tableOptions = null;
        ...
        $this->createTable('ecommerce_send_shipment_feedback_request', [
            'id' => $this->primaryKey(),
            ...
            'SkuBarcode' => $this->string(64)->defaultValue('')->comment(''),
            'Quantity' => $this->string(64)->defaultValue('')->comment(''),
            'WaybillSerial' => $this->string(64)->defaultValue('')->comment(''),
            'WaybillNumber' => $this->string(64)->defaultValue('')->comment(''),
    ...
    {
        $this->dropTable('{{%ecommerce_send_shipment_feedback_request}}');
    }
}
