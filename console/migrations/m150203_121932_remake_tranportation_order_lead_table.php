...
class m150203_121932_remake_tranportation_order_lead_table extends Migration
{
    public function up()
    {
        $tableOptions = null;
        ...
        $this->createTable('{{%transportation_order_lead}}', [
            ...
            'to_city_id' => Schema::TYPE_SMALLINT . "  NULL DEFAULT '0' COMMENT 'City to'",
            'recipient_name' => Schema::TYPE_STRING . '(128)  NULL COMMENT "Recipient name"',
            'recipient_phone' => Schema::TYPE_STRING . '(128)  NULL COMMENT "Recipient phone number"',
            'recipient_address' => Schema::TYPE_STRING . '(128)  NULL COMMENT "Recipient address"',
    ...
    {
        echo "m150203_121932_remake_tranportation_order_lead_table cannot be reverted.\n";
