...
class m150113_110905_create_table_inbound_order_items_process extends Migration
{
    public function up()
    {
        $tableOptions = null;
        ...
        $this->createTable('{{%inbound_order_items_process}}', [
            'id' => Schema::TYPE_PK,
            'inbound_order_id' => Schema::TYPE_INTEGER . ' NOT NULL COMMENT "Internal outbound order id"',
    ...
    {
        $this->dropTable('{{%inbound_order_items_process}}');
    }
}
