...
class m141107_041652_create_table_tl_delivery_proposal_billing extends Migration
{
    public function up()
    {
        $tableOptions = null;
        ...
        $this->createTable('{{%tl_delivery_proposal_billing}}', [
            'id' => Schema::TYPE_PK,
    ...
    {
        $this->dropTable('{{%tl_delivery_proposal_billing}}');
    }
}
