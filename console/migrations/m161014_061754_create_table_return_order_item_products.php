...
/**
 * Handles the creation for table `table_return_order_item_products`.
 */
class m161014_061754_create_table_return_order_item_products extends Migration
{
    /**
     * @inheritdoc
     */
    public function up()
    {
        ...
        $this->createTable('return_order_item_products', [
            'id' => $this->primaryKey(),
            'return_order_id' => Schema::TYPE_INTEGER . ' NOT NULL COMMENT "Internal return order id"',
            'return_order_item_id' => Schema::TYPE_INTEGER . ' NOT NULL COMMENT "Internal return order item id"',
            ...
            'client_box_barcode' => Schema::TYPE_STRING . '(54)  NULL COMMENT "client Box barcode"',
        ...
        $this->addColumn('{{%return_order_item_products}}','field_extra1',$this->string(64)->defaultValue('')->comment("Extra field 1")->after('product_serialize_data'));
        $this->addColumn('{{%return_order_item_products}}','field_extra2',$this->string(128)->defaultValue('')->comment("Extra field 2")->after('field_extra1'));
        $this->addColumn('{{%return_order_item_products}}','field_extra3',$this->string(256)->defaultValue('')->comment("Extra field 3")->after('field_extra2'));
        $this->addColumn('{{%return_order_item_products}}','field_extra4',$this->text()->defaultValue('')->comment("Extra field 4")->after('field_extra3'));
        $this->addColumn('{{%return_order_item_products}}','field_extra5',$this->text()->defaultValue('')->comment("Extra field 5")->after('field_extra4'));
    ...
    {
        $this->dropTable('return_order_item_products');
    }
}