...
/**
 * Class m200626_085348_ecommerce_check_box_inventory
 */
class m200626_085348_ecommerce_check_box_inventory extends Migration
{
    /**
     * @inheritdoc
     */
    public function safeUp()
    {
        ...
        $this->createTable('ecommerce_check_box_inventory', [
            'id' => $this->primaryKey(),
    ...
    {
        $this->dropTable('{{%ecommerce_check_box_inventory}}');
        return false;
    }
}
