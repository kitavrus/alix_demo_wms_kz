...
/**
 * Class m191011_135404_ecommerce_api_inbound_log
 */
class m191011_135404_ecommerce_api_inbound_log extends Migration
{
    /**
     * @inheritdoc
     */
    public function up()
    {
        $this->createTable('ecommerce_api_inbound_log', [
            'id' => $this->primaryKey(),
            'our_inbound_id' => $this->integer()->defaultValue(0)->comment("Our inbound id"),
            'our_inbound_item_id' => $this->integer()->defaultValue(0)->comment("Our inbound item id"),
    ...
    {
        $this->dropTable('ecommerce_api_inbound_log');
    }
}