...
/**
 * This is the model class for table "consignment_universal_orders".
 *
 * @property integer $id
 ...
 */
class ConsignmentUniversalOrders extends \common\models\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'consignment_universal_orders';
    }
    ...
    {
        return [
            [['status_notification','client_id', 'consignment_universal_id', 'from_point_id', 'to_point_id', 'order_type', 'status', 'expected_qty', 'accepted_qty', 'allocated_qty', 'accepted_number_places_qty', 'expected_number_places_qty', 'allocated_number_places_qty', 'created_user_id', 'updated_user_id', 'created_at', 'updated_at', 'deleted'], 'integer'],
            [['extra_fields', 'field_extra1', 'field_extra2', 'field_extra3', 'field_extra4', 'field_extra5'], 'string'],
            [['from_point_client_id', 'to_point_client_id', 'order_type_client', 'party_number', 'order_number', 'status_created_on_client'], 'string', 'max' => 128],
            [['box_barcode_client', 'box_barcode'], 'string', 'max' => 28],
        ];
    }
    ...
    /**
     * @inheritdoc
     * @return ConsignmentUniversalOrdersQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new ConsignmentUniversalOrdersQuery(get_called_class());
    }
}
