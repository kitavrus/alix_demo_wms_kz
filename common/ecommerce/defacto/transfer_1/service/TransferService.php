    ...
    private function prepareDataForSendByAPI($aDto) {
        ...
        foreach ($orderInfo->items as $item) {
            ...
            foreach ($productInBox as $product) {
                ...
                $transferOutboundBox = $product['transfer_outbound_box'];
                ...
                $productData->LcBarcode = $product['transfer_outbound_box'];
...
//                $productData->WaybillNumber =  $item->transfer_id;
	...
	private function makeWaybillNumber($boxBarcode) {
        return str_replace('0','',$boxBarcode);
    }
