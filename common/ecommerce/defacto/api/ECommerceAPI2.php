...
//    private $_url = 'https://dfstoretest.defacto.com.tr/DFStore.ProxyServices.T1/ExternalWMS/ExternalWMSProxy.asmx?WSDL'; // TEST for stock Adjustment
//      private $_url = 'https://dfstoretest.defacto.com.tr/DFStore.ProxyServices.T1/ExternalWMS/WmsEcommerceProxy.asmx?WSDL'; // TEST for stock Adjustment
...
//            'UserName'=>'wmsservicetestuser', // TEST for stock Adjustment
//            'Password'=>'zxc123**', // TEST for stock Adjustment
...
//        return $outResult;
    ...
    * */
//    public function CreateLcBarcode($params) //
//    {
//        return $this->sendRequest('CreateLcBarcode', $params);
//    }
...
//        die('-SendInBoundFeedBackData-');
     ...
     * */
    public function createLcBarcode($aCountBarcode = 10) // OK
    {
        $outResult = $this->_outResult;
        $params = [];
        $params['request'] = [
