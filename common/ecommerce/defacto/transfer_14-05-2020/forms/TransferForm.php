...
{
    const SCENARIO_OUR_BOX_BARCODE = 'PIKING-LIST-BARCODE';
    ...
    {
        return [
            [['pickingListBarcode'], 'trim', 'on' => self::SCENARIO_OUR_BOX_BARCODE],
            [['pickingListBarcode'], 'string', 'on' => self::SCENARIO_OUR_BOX_BARCODE],
            ...
            [['lcBarcode'], 'trim', 'on' => self::SCENARIO_EMPTY_BOX],
            [['lcBarcode'], 'string', 'on' => self::SCENARIO_EMPTY_BOX],
            [['lcBarcode'], 'required', 'on' => self::SCENARIO_EMPTY_BOX],
            [['pickingListBarcode'], 'required', 'on' => self::SCENARIO_EMPTY_BOX],

            [['lcBarcode'], 'trim', 'on' => self::SCENARIO_SHOW_BOX_ITEMS],
            [['lcBarcode'], 'string', 'on' => self::SCENARIO_SHOW_BOX_ITEMS],
            [['lcBarcode'], 'required', 'on' => self::SCENARIO_SHOW_BOX_ITEMS],
...
//        if (!$this->check->isOurBoxBarcodeExist($ourBoxBarcode)) {
//            $this->addError($attribute, '<b>[' . $ourBoxBarcode . ']</b> ' . Yii::t('outbound/errors', 'Это шк нет в системе'));
//        }
    }
