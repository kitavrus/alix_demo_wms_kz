...
//            'sort' => ['defaultOrder' => ['created_at' => SORT_ASC]]
    ...
    public function getOrderInfo($aTransferId)
    {
        ...
        $boxItems = EcommerceStock::find()->select('transfer_outbound_box')->distinct()
                    ->andWhere(["transfer_id" => $aTransferId])
                    ->andWhere('transfer_outbound_box != ""')
					->asArray()
                    ->column();
...
//            'client_LcBarcode'=>TransferDefaultValue::MAIN_VIRTUAL_BOX,
    ...
    public function getQtyProductsInOurBox($aLcBarcode,$aPikingListBarcode) {
...
//            'box_address_barcode' =>  $aOurBarcode,
    ...
    public function getQtyProductsInLc($aLcBarcode,$aPikingListBarcode) {
    ...
    public function getProductInfoInOurBox($aProductBarcode,$aLcBarcode = null,$aPikingListBarcode) {
...
//            'product_barcode' => $aProductBarcode,
    ...
    public function resetTransferOrder ($aTransferId) {
        ...
        EcommerceStock::updateAll([
            ...
            'system_message' => "reset-transfer:".$aTransferId,
        ],['transfer_id'=>$aTransferId]);
    }
