...
use common\ecommerce\defacto\transfer\validation\TransferValidationV2;
use yii\base\Model;
use Yii;

class TransferFormV2 extends Model
{
    ...
    public function __construct($config = [])
    {
        ...
        $this->check = new TransferValidationV2();
        $this->service = new TransferServiceV2();
    }
...
//        VarDumper::dump($this->getDTO(),10,true);
//        die;
