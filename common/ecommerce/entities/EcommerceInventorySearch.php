...
/**
 * EcommerceInventorySearch represents the model behind the search form about `common\ecommerce\entities\EcommerceInventory`.
 */
class EcommerceInventorySearch extends EcommerceInventory
{
    /**
     * @inheritdoc
     */
