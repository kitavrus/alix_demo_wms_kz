...
/**
 * EcommerceCheckBoxInventorySearch represents the model behind the search form of `common\ecommerce\entities\EcommerceCheckBoxInventory`.
 */
class EcommerceCheckBoxInventorySearch extends EcommerceCheckBoxInventory
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = EcommerceCheckBoxInventory::find();
