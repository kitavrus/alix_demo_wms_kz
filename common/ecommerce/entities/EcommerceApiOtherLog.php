...
/**
 * This is the model class for table "ecommerce_api_other_log".
 *
 * @property int $id
 ...
 */
class EcommerceApiOtherLog extends \common\models\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'ecommerce_api_other_log';
    }
    ...
    {
        return [
            [['request_is_success', 'response_is_success', 'created_user_id', 'updated_user_id', 'created_at', 'updated_at', 'deleted'], 'integer'],
