...
class EcommerceInboundItemSearch extends EcommerceInboundItem
{
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'client_box_barcode', $this->client_box_barcode])
            ->andFilterWhere(['like', 'client_lot_sku', $this->client_lot_sku])
            ->andFilterWhere(['like', 'client_product_sku', $this->client_product_sku])
            ->andFilterWhere(['like', 'our_box_barcode', $this->our_box_barcode])
