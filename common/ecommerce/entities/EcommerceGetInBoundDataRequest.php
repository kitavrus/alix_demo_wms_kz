...
/**
 * This is the model class for table "ecommerce_get_inbound_data_request".
 *
 * @property int $id
 * @property int $our_inbound_id
 * @property string $BusinessUnitId
 * @property string $LcBarcode
 ...
 */
class EcommerceGetInBoundDataRequest extends  \common\models\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'ecommerce_get_inbound_data_request';
    }
    ...
    public function rules()
    {
        return [
            ...
            [['BusinessUnitId', 'LcBarcode'], 'string', 'max' => 64],
        ];
    }
