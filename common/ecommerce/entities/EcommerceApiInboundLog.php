...
/**
 * This is the model class for table "ecommerce_api_inbound_log".
 *
 * @property int $id
 * @property int $our_inbound_id Our inbound id
 * @property int $our_inbound_item_id Our inbound item id
 ...
 */
class EcommerceApiInboundLog extends \common\models\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'ecommerce_api_inbound_log';
    }
    ...
    {
        return [
            [['our_inbound_id', 'our_inbound_item_id', 'request_is_success', 'response_is_success', 'created_user_id', 'updated_user_id', 'created_at', 'updated_at', 'deleted'], 'integer'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'our_inbound_item_id' => 'Our Inbound Item ID',
