...
/**
 * This is the model class for table "ecommerce_check_box_inventory".
 *
 * @property int $id
 ...
 */
class EcommerceCheckBoxInventory extends \common\models\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'ecommerce_check_box_inventory';
    }
