...
/**
 * This is the model class for table "ecommerce_inventory_rows".
 *
 * @property integer $id
 ...
 */
class EcommerceInventoryRows extends \common\models\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'ecommerce_inventory_rows';
    }
...
//            'deleted' => Yii::t('app', 'Deleted'),
    ...
    {
        return (new EcommerceInventory)->getStatusArray();
    }
    ...
    public function getStatusValue($status = null)
    {
        ...
        return ArrayHelper::getValue((new EcommerceInventory)->getStatusArray(), $status);
    }
}
