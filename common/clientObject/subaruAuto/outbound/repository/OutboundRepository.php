...
namespace common\clientObject\subaruAuto\outbound\repository;
...
//            }
//
//            $outboundOrderItem->accepted_qty = $this->getQtyScannedWithFabProduct($dto->productBarcode,$dto->fabBarcode,$dto->order->id);
//
//            if ($outboundOrderItem->accepted_qty == $outboundOrderItem->expected_qty || $outboundOrderItem->accepted_qty == $outboundOrderItem->allocated_qty ) {
//                $outboundOrderItem->status = Stock::STATUS_OUTBOUND_SCANNED;
//            }
...
//    private function makeCleanBoxStock($productBarcode,$boxBarcode,$orderId) {
//
...
//    private function getQtyScannedWithFabProduct($productBarcode,$fabBarcode,$orderId) {
//        return Stock::find()->andWhere([
//            'product_barcode'=>$productBarcode,
//            'outbound_order_id' => $orderId,
//            'status'=>Stock::STATUS_OUTBOUND_SCANNED,
//            'client_id' => $this->getClientID(),
////            'field_extra2' => $fabBarcode,
//        ])->count();
//    }
...
//    public function isNextBarcodeWithFabInOrder($outboundId,$productBarcode) {
//
//        return OutboundOrderItem::find()->andWhere([
//            'outbound_order_id'=>$outboundId,
//            'product_barcode'=>$productBarcode,
...
//                'outbound_picking_list_id' => $pickListID,
    ...
    public function getOrderItemsForDiffReport_old($pickListID)
    {
        $subQuery = (new Query())
            ->select('count(*)')
            ->from('stock as stck')
...
//    public function isFabExist($productBarcode,$fabBarcode) {
//        return Stock::find()
//            ->andWhere([
//                'product_barcode' => $productBarcode,
//                'field_extra2' => $fabBarcode,
