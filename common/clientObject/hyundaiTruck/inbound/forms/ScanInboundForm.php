...
namespace common\clientObject\hyundaiTruck\inbound\forms;

use common\clientObject\hyundaiTruck\inbound\validation\InboundOrderValidation;
use Yii;
use yii\base\Model;
...
//        $dto->clientId = 0;
    ...
    public function preparedProductModel($productModel) {
        file_put_contents('preparedProductModel-hyundai-truck.log',$productModel."\n",FILE_APPEND);
