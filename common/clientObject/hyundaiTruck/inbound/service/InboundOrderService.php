...
namespace common\clientObject\hyundaiTruck\inbound\service;
...
class InboundOrderService
{
    ...
    public function __construct($dto = []) {
        $this->inboundRepository = new \common\clientObject\hyundaiTruck\inbound\repository\InboundRepository($dto);
...
//        $this->inboundRepository->updateAcceptedQtyItemByProductModelBarcode($this->dto->orderNumberId,$this->dto->productBarcode);
