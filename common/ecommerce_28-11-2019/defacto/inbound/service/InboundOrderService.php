...
class InboundOrderService
{
    ...
    public function __construct($dto = []) {
        $this->inboundRepository = new \common\ecommerce\defacto\inbound\repository\InboundRepository();
        $this->stockService = new \common\ecommerce\defacto\stock\service\Service();
        $this->productService = new \common\modules\product\service\ProductService();
        $this->apiService = new \common\ecommerce\defacto\inbound\service\InboundAPIService();
...
//        $this->stockService->setStatusNewAndAvailableYes($this->dto->orderNumberId);
        ...
        // send by API
        $this->sendByAPI($this->dto->orderNumberId,'2430008755695');
