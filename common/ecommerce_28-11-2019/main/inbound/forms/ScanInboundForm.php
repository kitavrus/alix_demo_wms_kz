...
use common\ecommerce\main\inbound\validation\InboundOrderValidation;
use Yii;
use yii\base\Model;
...
class ScanInboundForm extends Model
{
    ...
    public function rules()
    {
        return [
            ...
            // Scan product
            [['productBarcode', 'transportedBoxBarcode', 'orderNumberId','productModel'], 'required', 'on' => 'onProductBarcode'],
            ...
            [['transportedBoxBarcode', 'orderNumberId','productModel'], 'required', 'on' => 'onCleanTransportedBox'],
            [['transportedBoxBarcode','productModel'], 'string', 'on' => 'onCleanTransportedBox'],
            [['transportedBoxBarcode','productModel'], 'trim', 'on' => 'onCleanTransportedBox'],
