 ...
 */
class EcommerceCheckBox extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['client_id', 'warehouse_id', 'employee_id', 'expected_qty', 'scanned_qty', 'created_user_id', 'updated_user_id', 'created_at', 'updated_at', 'deleted'], 'integer'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'place_address_part1' => 'Place Address Part1',
            'place_address_part2' => 'Place Address Part2',
            'place_address_part3' => 'Place Address Part3',
            'place_address_part4' => 'Place Address Part4',
            'place_address_part5' => 'Place Address Part5',
