...
namespace common\b2b\domains\checkBox\forms;

use common\b2b\domains\checkBox\constants\CheckBoxStatus;
use common\b2b\domains\checkBox\service\CheckBoxService;
...
class CheckBoxForm extends Model
{
    ...
    public function __construct($config = [])
    {
        ...
        $this->validation = new \common\b2b\domains\checkBox\validation\Validation();
