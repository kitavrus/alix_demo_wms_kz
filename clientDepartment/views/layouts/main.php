            ...
            } elseif($client->client_id == 66)
            {
				...
				switch ($client->manager_type) {
					case ClientEmployees::TYPE_BASE_ACCOUNT:
						$menuItems = [
							['label' => Yii::t('titles', 'Transportation orders'), 'url' => ['/transportLogistics/tl-delivery-proposal/index']],
							['label' => Yii::t('titles', 'Outbound'), 'url' => ['/warehouseDistribution/erenRetail/uploads/index']],
							['label' => Yii::t('titles', 'Reports'), 'url' => '', 'items'=>[
								['label' => Yii::t('titles', 'Operation report'), 'url' => ['/report/outbound/operation-report']],
								['label' => Yii::t('titles', 'Outbound orders report'), 'url' => ['/report/outbound/index']],
								['label' => Yii::t('titles', 'Inbound'), 'url' => ['/report/inbound/index']],
								['label' => Yii::t('titles', 'Остатки на складке'), 'url' => ['/report/stock/search-remains']],
								['label' => Yii::t('titles', 'История по штрихкоду'), 'url' => ['/report/stock/search-history-by-barcode']],
								['label' => Yii::t('titles', 'Отгрузки по коробам'), 'url' => ['/report/erenRetail/other-delivery/index']],
							]],
                    ...
                    case ClientEmployees::TYPE_OBSERVER:
                        $menuItems = [
                            ...
                            ['label' => Yii::t('titles', 'Reports'), 'url' => '', 'items'=>[
								...
								['label' => Yii::t('titles', 'Qty box on stock'), 'url' => ['/report/stock/qty-box-defacto']],
								['label' => Yii::t('titles', 'Last day delivery'), 'url' => ['/transportLogistics/last-day-check/index']],
                            ]],
                        ...
                        if($client->client_id == Client::CLIENT_DEFACTO){
                            ...
                            $menuItems[4]['items'][] =  ['label' => Yii::t('titles', 'НЕ Nomadex'), 'url' => ['/report/other-delivery/outbound']];
                            $menuItems[4]['items'][] =  ['label' => Yii::t('titles', 'НЕ Nomadex Belarus'), 'url' => ['/report/other-delivery/outbound-minsk']];
							$menuItems[4]['items'][] =  ['label' => Yii::t('titles', 'НЕ Nomadex Russia'), 'url' => ['/report/other-delivery/outbound-russia']];
                        }
