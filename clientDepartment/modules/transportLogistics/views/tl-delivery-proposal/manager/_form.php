...
//            ]
//        ]
    )->dropDownList(TLHelper::getStoreArrayByClientID(ClientEmployees::findOne(['user_id'=>Yii::$app->user->id])->client_id,true),['disabled'=>true]);

//    ->widget(Select2::classname(), [
//
//    'language' => 'ru',
//    'data' => TLHelper::getStoreArrayByClientID(ClientEmployees::findOne(['user_id'=>Yii::$app->user->id])->client_id,true),
//    'options' => [
//        'placeholder' => Yii::t('transportLogistics/titles', 'Select route from'),
//    ],
//    'pluginOptions' => [
//        'allowClear' => true,
//    ],
