...
?>
    <div class="tl-delivery-proposal-view">
        ...
        <h1><?= Html::encode(Yii::t('titles','Request for delivery')).'   № '.$model->id ?></h1>
...
//                'label' => Yii::t('transportLogistics/buttons','Print box label'),
//                'dropdown' => [
//                    'items' => [
...
//        'order_id',
        ...
        [
            ...
            'value' => function ($model) {return TlDeliveryProposalOrders::getOrderTypeValue($model->order_type);},
        ],
        [
...
<?php //if(ClientManager::canUpdateStoreReview($model) ) { ?>
