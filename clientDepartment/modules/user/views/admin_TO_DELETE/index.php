 ...
 * @var clientDepartment\modules\user\models\UserSearch $searchModel
 */
    ...
    'columns' => [
        ...
        [
            ...
            'value' => function ($model, $key, $index, $widget) {
                return $model->getUserTypeArray($model->user_type);
            },
            'filter' => Html::activeDropDownList($searchModel, 'user_type', (new User())->getUserTypeArray(), ['class' => 'form-control', 'prompt' => ''])
        ],
        'email:email',
        [
