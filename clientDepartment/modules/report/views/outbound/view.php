...
<!--    --><?php //echo Html::tag('span',Yii::t('transportLogistics/buttons','Export to Exel'),['class' => 'btn btn-success','id'=>'report-order-export-plus-product-btn', 'data-url'=>'/report/outbound/export-to-excel-plus-product']) ?>
    <?= Html::a(Yii::t('transportLogistics/buttons','Export to Excel'),Url::to(['export-to-excel-plus-product','id'=>$model->id]),['class' => 'btn btn-success','id'=>'report-order-export-plus-product-btn', 'data-url'=>'/report/outbound/export-to-excel-plus-product']) ?>
