...
$this->title = Yii::t('outbound/titles', ' Не NOMADEX');
...
//        $class = iHelper::getStockGridColor();
		$class = '';
        if ($data['print_outbound_status'] == "yes") {
			$class = 'color-orange';
        }
...
//            console.log($('#grid-view-order-items').data('key="39"'));
            ...
            if (keys.length < 1) {
                ...
                window.location.href = '/report/other-delivery/print?ids=' + keys;
