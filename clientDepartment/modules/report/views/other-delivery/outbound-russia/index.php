...
$this->title = Yii::t('outbound/titles', ' Не NOMADEX Russia');
...
<div>
    ...
    <?= Html::tag('span', Yii::t('transportLogistics/buttons', 'Export to Excel'), ['class' => 'btn btn-success', 'id' => 'report-order-export-btn', 'data-url' => '/outbound-russia/report/export-to-excel']) ?>
    <br/>
</div>
...
//            console.log($('#grid-view-order-items').data('key="39"'));
            ...
            if (keys.length < 1) {
                ...
                window.location.href = '/report/other-delivery/print-russia?ids=' + keys;
