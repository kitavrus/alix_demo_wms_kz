...
<div class="scanning-form">
    ...
    <?= $form->field($model, 'employee_barcode')->textInput([
        ...
        'data' => ['url'=>Url::toRoute('/warehouseDistribution/defacto/outbound/employee-barcode-scanning-handler')]
    ]); ?>
    ...
    <?= $form->field($model, 'picking_list_barcode',
        ...
        'data' => ['url'=>Url::toRoute('/warehouseDistribution/defacto/outbound/picking-list-barcode-scanning-handler')]
    ]) ?>
    ...
    <?= $form->field($model, 'box_barcode', [
        ...
        'class' => 'form-control ext-large-input',
        'data' => ['url'=>Url::toRoute('/warehouseDistribution/defacto/outbound/box-barcode-scanning-handler')]
    ...
    <?= $form->field($model, 'product_barcode',
        ...
        'class' => 'form-control ext-large-input',
        'data' => ['url'=>Url::toRoute('/warehouseDistribution/defacto/outbound/product-barcode-scanning-handler')]
    ...
    <div class="row" style="margin: 20px 1px">
        ...
        <?= Html::tag('span', Yii::t('outbound/buttons', 'List differences'), ['data-url' => Url::toRoute('/warehouseDistribution/defacto/outbound/printing-differences-list'), 'class' => 'btn btn-success', 'id' => 'scanning-form-differences-list-bt', 'style' => 'margin-left:10px;']) ?>
        <?= Html::tag('span', Yii::t('outbound/buttons', 'Print box label'), ['data-url' => Url::toRoute('/warehouseDistribution/defacto/outbound/printing-box-label'), 'class' => 'btn btn-success', 'id' => 'scanning-form-print-box-label-bt', 'style' => 'margin-right:10px; float:right;']) ?>
