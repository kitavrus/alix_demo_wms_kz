...
<script type="text/javascript">
    $(function(){
        ...
        body.on('click', '#tupperware-reset-upload-bt', function(){
            window.location.href = $(this).data('url');
        });

        body.on('click', '#tupperware-confirm-upload-btn', function(){
            var from_id = $('#tupperwareoutboundform-from_point').val(),
                to_id = $('#tupperwareoutboundform-to_point').val();
