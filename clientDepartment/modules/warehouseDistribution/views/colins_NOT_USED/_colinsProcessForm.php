...
<span id="buttons-menu">
    ...
    <?= Html::tag('span', Yii::t('outbound/buttons', 'Inbound'), ['data'=>['url'=>Url::toRoute('/warehouseDistribution/colins/inbound/index')],'class' => 'btn btn-primary btn-lg', 'style' => ' margin:10px;', 'id' => 'inbound-colins-bt']) ?>
