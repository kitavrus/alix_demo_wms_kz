...
<div class="report-order-view">
 ...
 <?= Html::a(Yii::t('transportLogistics/buttons','Export to Excel'),Url::to(['/report/outbound/export-to-excel-plus-product','id'=>$model->id]),['class' => 'btn btn-success','id'=>'report-order-export-plus-product-btn']) ?>
