			...
			[
				...
				'value' => function ($data) {
					return ''
						...
						.'<h4 class="pull-left">'.Html::tag('a', 'print boxes', ['href'=>Url::to(['/report/outbound/print-box-kg-list', 'id' => $data->id]),'class'=>'label label-default','style'=>'margin:5px; display: block;'])
						//."<br />"
						.Html::tag('a', 'products in box', ['href'=>Url::to(['/report/outbound/print-products-in-box', 'id' => $data->id]),'class'=>'label label-default','style'=>'margin:5px; display: block;'])
						.'</h4>';
				},
			],
            'expected_qty',
