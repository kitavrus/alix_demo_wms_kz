...
<script type="text/javascript">
    $(function(){
        ...
        body.on('click', '#akmaral-reset-upload-bt', function(){
            window.location.href = $(this).data('url');
        });

        body.on('click', '#akmaral-confirm-upload-btn', function(){
            var from_id = $('#akmaraloutboundform-from_point').val(),
                to_id = $('#akmaraloutboundform-to_point').val();
