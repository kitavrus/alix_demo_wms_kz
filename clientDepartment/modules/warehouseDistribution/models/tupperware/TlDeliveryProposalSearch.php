...
namespace app\modules\warehouseDistribution\models\tupperware;
...
//                        case ClientEmployees::TYPE_MANAGER_INTERN:
                                ...
                                self::STATUS_ADD_ROUTE_TO_DP,
                                self::STATUS_ADD_CAR_TO_ROUTE,
                                self::STATUS_ROUTE_FORMED,
                                self::STATUS_NOT_ADDED_M3,
                                ];
//                                die('fgggg');
                            break;
