...
$(function() {
    ...
    $("#inventoryform-place_address_barcode, #inventoryform-box_address_barcode, #inventoryform-product_barcode").on('click', function (e) {
        $(this).select().focus();
    ...
    //
    $("#inventoryform-place_address_barcode").on('keyup', function (e) {
        if (e.which == 13) {
            var me = $(this);
            console.info("-inventoryform-place_address_barcode-");
            ...
            $.post(me.data('url'), form.serialize(),function (response) {
                if (response.success == 0) {
                    ...
                    $('#inventoryform-box_address_barcode').addClass('hidden');
                    $('#inventoryform-product_barcode').addClass('hidden');

                    $('#inventoryform-box_address_barcode').focus().select();
                }
...
//                alert(errorThrown);
    ...
    //
    $("#inventoryform-box_address_barcode").on('keyup', function (e) {
        if (e.which == 13) {
            var me = $(this);
            console.info("-inventoryform-box_address_barcode-");
            console.info("Value : " + me.val());
...
//                alert(errorThrown);
    ...
    b.on('click',"#continue-inventory-bt", function (e) {
        ...
        $('#inventoryform-box_address_barcode').removeClass('hidden');
