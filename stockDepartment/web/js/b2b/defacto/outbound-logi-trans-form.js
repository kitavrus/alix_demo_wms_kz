...
function initClient() {
    ...
    if (client_id) {
        ...
        $.post('/wms/defacto/outbound-logi-trans/get-parent-order-number', {'client_id': client_id}).done(function (result) {
 ...
 * */
$(function () {
    console.info('-init-defacto-outbound-logi-trans');
    var b = $('body'),
        outboundRoute = '/wms/defacto/outbound-logi-trans/';
    ...
    b.on('click', '#outbound-print-pick-list-bt', function () {
        ...
        var client_id = $('#main-form-client-id').val(),
            url = $(this).data('url'),
            orderUrl = '/wms/defacto/outbound-logi-trans/get-parent-order-number',
            dataOptions = '';
...
//
    ...
    b.on('click', '#scanning-process-bt', function () {
        ...
        $.post(url, function (data) {
            ...
            //$('#scanningform-employee_barcode').hide();
...
//                    console.info('OK->OK-> scanning-form-employee-barcode');
    ...
    b.on('change', "#scanningform-picking_list_barcode", function (e) {
