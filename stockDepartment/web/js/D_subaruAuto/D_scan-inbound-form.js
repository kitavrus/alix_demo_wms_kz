...
$(function() {
    ...
    //
    b.on('click',transportedBoxBarcodeID+", "+productBarcodeID+", "+productModelID,function(e) {
    ...
    //
    b.on('keyup',productModelID, function (e) {
    ...
    b.on('keyup',productBarcodeID, function (e) {
        ...
        if($(this).val() == 'CLEAN-BOX') {
            me.val('');
            cleanTransportedBox(me.data('clean-url'));
            return false;
        }
    ...
    //
    function cleanTransportedBox (url) {
