...
$(function() {
   console.info('INIT Return JS');
    ...
    $(function() {
        ...
        b.on('click',"#returnform-box_barcode, #returnform-product_barcode, #returnform-order_number", function (e) {
            $(this).focus().select();
        });
...
//
        ...
        b.on('keyup',"#returnform-product_barcode", function (e) {
            ...
            if (e.which == 13) {
                ...
                $.post('/returnOrder/default/product-barcode', form.serialize(),function (result) {
...
//
        ...
        b.on('click','#return-form-print-box-label-bt',function() {
            ...
            if(confirm('Вы действительно хотите принять короб на склад')) {
                ...
                //$.post(href, {'id':returnOrderIDValue},function (result) {
                //
                //    console.info(result);
                //
                //    if (result.success == 0 ) {
...
//                });
                ...
                $('#count-product-in-box').html('0/0');
                $('#returnform-product_barcode').val('');
