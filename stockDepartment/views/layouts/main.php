...
//                'brandLabel' => 'Nomadex WMS 2.0',
        ...
        $menuItems = [
           ...
           /*  ['label' => Yii::t('titles', 'Запчасти'), 'url' => '', // перево Склад
                'items' => [ // 0
...
*/
            ['label' => Yii::t('titles', 'Stock'), 'url' => '', // перево Склад
                'items' => [  // 1
				    ['label' => Yii::t('titles', 'Приход InterMode'), 'url' => ['/wms/erenRetail/inbound']],
                  //  ['label' => Yii::t('titles', 'Расход InterMode'), 'url' => ['/wms/erenRetail/outbound-common']],
					 ['label' => Yii::t('titles', 'Короб на полку InterMode'), 'url' => ['/wms/erenRetail/place-to-address/index']],
					  ['label' => Yii::t('titles', 'DataMatrix InterMode'), 'url' => ['/wms/erenRetail/inbound-data-matrix/index']],
					  ['label' => Yii::t('titles', 'Расход DataMatrix InterMode'), 'url' => ['/wms/erenRetail/outbound-data-matrix/scanning-form']],
					 ['label' => Yii::t('titles', 'Из короба в короб InterMode'), 'url' => ['/wms/erenRetail/place-to-address/box-to-box']],
					 ['label' => Yii::t('titles', 'Из короба в короб поштучно InterMode'), 'url' => ['/wms/erenRetail/place-to-address/product-in-box-to-box']],
					 ['label' => Yii::t('titles', 'История размещения InterMode'), 'url' => ['/stock/change-address-place/index']],
					 ['label' => Yii::t('titles', '------------------'), 'url' => ['/']],
					 ['label' => Yii::t('titles', '---------NEW Begin---------'), 'url' => ['/']],
					 ['label' => Yii::t('titles', 'Приход NEW InterMode'), 'url' => ['/intermode/inbound/scanning/index']],
					 ['label' => Yii::t('titles', 'Расход NEW InterMode'), 'url' => ['/intermode/outbound/scanning/scanning-form']],
					 ['label' => Yii::t('titles', 'Фиксируем окончание сборки'), 'url' => ['/intermode/outbound/picking/scanning-form']],
					 ['label' => Yii::t('titles', 'Отчет отгрузки InterMode'), 'url' => ['/intermode/outbound/report/index']],
					  ['label' => Yii::t('titles', 'Ecommerce'), 'url' => ['/intermode/ecommerce/default/index']],
					  ['label' => Yii::t('titles', 'Отчет по API логам'), 'url' => ['/intermode/cronManager/report/index']],
					
					['label' => Yii::t('titles', 'Загрузить накладную извлечения'), 'url' => ['/intermode/outboundSeparator/uploads/form']],
					['label' => Yii::t('titles', 'Сканировать извлечения'), 'url' => ['/intermode/outboundSeparator/scanning/form']],
					['label' => Yii::t('titles', 'Отчет по извлечениям'), 'url' => ['/intermode/outboundSeparator/reports/grid']],
					
					 ['label' => Yii::t('titles', 'Связать DM и наш ШК'), 'url' => ['/intermode/bind/bind-qr-code']],
					 ['label' => Yii::t('titles', 'Связь DM и наш ШК: отчет'), 'url' => ['/intermode/bind/report/bind-qr-code-report']],
					
					 ['label' => Yii::t('titles', '---------NEW end---------'), 'url' => ['/']],
					 ['label' => Yii::t('titles', '------------------'), 'url' => ['/']],
...
//                    ['label' => Yii::t('titles', 'Orders'), 'url' => ['/order/order-process/steps']],
					...
					['label' => Yii::t('titles', 'Поиск по 8000 на нахождения LC'), 'url' => ['/wms/defacto/outbound-boxes/index']],
                    ['label' => Yii::t('titles', 'Inventory').' Создать', 'url' => ['/wms/erenRetail/inventory/index']],
                    ['label' => Yii::t('titles', 'Inventory').' Сканирование', 'url' => ['/wms/erenRetail/inventory-process/index']],
...
//                    ['label' => Yii::t('titles', 'Warehouse Distribution'), 'url' => ['/warehouseDistribution/default/index']],
					...
					['label' => Yii::t('titles', 'Inventory обработка короба'), 'url' => ['/wms/erenRetail/check-box/scanning']],
                    ['label' => Yii::t('titles', 'Inventory отчет по коробам'), 'url' => ['/wms/erenRetail/check-box/index']],
                   ['label' => Yii::t('titles', 'Inventory коробочный отчет'), 'url' => ['/wms/erenRetail/check-box-inventory/index']],			
                ],
            ],
...
//                    ['label' => Yii::t('titles', 'Warehouses'), 'url' => ['/warehouse/default/index']],
                    ...
                    ['label' => Yii::t('titles', 'Kpi setting'), 'url' => ['/kpiSettings/default/index']],
					 ['label' => Yii::t('titles', 'Восстановить/Заблокировать товар'), 'url' => ['/stock/restore-product/index']],
...
//                    ['label' => Yii::t('titles', 'Route unforeseen expenses type'), 'url' => ['/transportLogistics/route-unforeseen-expenses-type/index']],
            ...
            ['label' => Yii::t('titles', 'Reports'), 'url' => '/report/default/index',
				...
				['label' => Yii::t('titles', 'Браки на складе'), 'url' => ['/stock/defect']],
                ['label' => Yii::t('titles', 'На склaде сделать браком/не браком'), 'url' => ['/stock/make-defect']],
                ['label' => Yii::t('titles', 'Вернуть в заказ/Убрать из заказа'), 'url' => ['/outbound/return-to-order/index']],
             ...
             //   ['label' => Yii::t('titles', 'Cross-dock orders report'), 'url' => ['/crossDock/report/index']],
				...
				['label' => Yii::t('titles', 'История размещений'), 'url' => ['/stock/change-address-place']],
				['label' => Yii::t('titles', 'Товары'), 'url' => ['/product/default/index']],
...
//                ['label' => Yii::t('titles', 'History'), 'url' => ['/stock/stock/search-history-by-barcode']],
            ...
            ['label' => Yii::t('titles', 'Billing'), 'url' => '/billing/default/index',
                'items'=>[  // 5
           ...
           /* ['label' => Yii::t('titles', 'Defacto'), 'url' => '/wms/default/route-form?id=2',
                'items'=>[
                    ['label' => Yii::t('titles', 'E-Commerce'), 'url' => '/ecommerce/defacto/default/start'],
                    ['label' => Yii::t('titles', 'Отг-ка'), 'url' => '/tms/box-out/outbound-list'],
                    ['label' => Yii::t('titles', 'Для магазинов'), 'url' => '/wms/default/route-form?id=2'],
                    ['label' => Yii::t('titles', 'Не наши перевозки'), 'url' => '/wms/defacto/other-delivery/outbound']
                ],
            ], */
