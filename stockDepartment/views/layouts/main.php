            ...
            ['label' => Yii::t('titles', 'Stock'), 'url' => '', // перево Склад
                'items' => [  // 1
                  ...
                  //  ['label' => Yii::t('titles', 'Расход InterMode'), 'url' => ['/wms/erenRetail/outbound-common']],
					 ...
					 ['label' => Yii::t('titles', 'Обработка расходов'), 'url' => ['/alix/ecommerce/outbound/scanning/index']],
					 ['label' => Yii::t('titles', 'Лист отгрузки'), 'url' => ['/alix/ecommerce/outbound/outbound-list/scanning-form']],
					 ['label' => Yii::t('titles', 'Отчет отгрузки'), 'url' => ['/alix/ecommerce/outbound/report/index']],
