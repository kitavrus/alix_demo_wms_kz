...
// Пунк погрузки
$loadingPoint = $model->routeFrom->getPointTitleByPattern('{city_name} / {name} {shop_code}, {shopping_center_name} {street} {house}');

// Пункт разгрузки
$unloadingPoint = $model->routeTo->getPointTitleByPattern('{city_name} / {name} {shop_code}, {shopping_center_name} {street} {house}');
...
//);
//
//$pdf->write1DBarcode("zxc-123-zxc", 'C128',205,0, 80, 9, 1.5, $style, 'C');
////$pdf->SetXY(0,0);
