...
$mcActual = (!empty($modelDpRouteCar->mc_actual) ? $modelDpRouteCar->mc_actual : '0');// . ' ' . Yii::t('titles', 'М3');// . "<br />";
$kgActual = (!empty($modelDpRouteCar->kg_actual) ? $modelDpRouteCar->kg_actual : '0');// . ' ' . Yii::t('titles', 'Кг') . "<br />";
...
$html = '<table width="100%" style="padding:2px;" border="1">
             <tr>
                 ...
                 <td width="7%">Масса брутто факт, кг.</td>
             </tr>
             ' . $html_in . '
             <tr>
                 <td width="10%">&nbsp;</td>
