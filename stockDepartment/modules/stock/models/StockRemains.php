...
//        $query->orWhere(['client_id' => $this->client_id, 'outbound_order_id' => [884,883,882,881]]);
 ...
 */
    public function searchArray($params)
    {
        ...
        $query = Stock::find()->select('inventory_secondary_address, inventory_primary_address, inventory_id, consignment_inbound_id, inbound_order_id, client_id, id, product_barcode, primary_address, secondary_address, status_availability, status_lost, product_model, condition_type, status, count(id) as qty, product_sku');
...
//            $query->groupBy('product_barcode, consignment_inbound_id');
