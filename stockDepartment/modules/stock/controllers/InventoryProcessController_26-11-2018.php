...
//                $stockRowBoxQty = Stock::find()->andWhere(['secondary_address'=>$minMax,'inventory_id'=>$inventoryForm->inventory_id])->groupBy('primary_address')->count();
                ...
                if (!$invRow = InventoryRows::find()->andWhere(['inventory_id'=>$inventoryForm->inventory_id,'column_number'=>$column_number,'floor_number'=>$floor_number,'level_number'=>$level_number])->one()) {
