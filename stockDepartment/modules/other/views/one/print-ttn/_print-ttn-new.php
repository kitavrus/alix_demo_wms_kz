...
<table width="100%" style="padding:2px"  border="0">
            <tr>
                ...
                <td width="42%" style="font-weight:normal;">ТОО "Hyundai Auto Kazakhstan"</td>
                <td width="9%" style="font-weight:normal;">Водитель</td>
                <td width="12%" style="font-weight:normal;">ФИО</td>
            ...
            <tr>
             ...
             <tr>
                ...
                <td width="42%" style="font-weight:normal;">ТОО "Hyundai Auto Kazakhstan"  код</td>
                <td width="9%" style="font-weight:normal;"></td>
                <td width="12%" style="font-weight:normal;"></td>
                <td width="20%" style="font-weight:normal;"></td>
            </tr>
            ...
            <tr>
                <td width="12%" style="font-weight:normal;">Грузоотправитель</td>
                 <td width="42%" style="font-weight:normal;">ТОО "Nomadex 3PL" код</td>
                 <td width="9%" style="font-weight:normal;"></td>
                <td width="12%" style="font-weight:normal;"></td>
                <td width="20%" style="font-weight:normal;"></td>
            </tr>
            ...
            <tr>
                ...
                <td width="12%" style="font-weight:normal;">'.$endPointAddress.'</td>
                <td width="20%" style="font-weight:normal;">Маршрут №</td>
            </tr>
            <tr>
                <td width="12%" style="font-weight:normal;"></td>
...
<table width="100%" style="padding:2px"  border="0">
            ...
            <tr>
                <td width="57%" style="font-weight:normal;">___________________________________________________________________________________ __    2.</td>
                <td width="37%" style="font-weight:normal;">Прицеп_____________________________ Гар.№</td>
            </tr>
            <tr>
                <td width="57%" style="font-weight:normal;">наименование и адрес нового грузополучателя</td>
...
<table width="100%" style="padding:2px"  border="1">
            <tr>
                <td height="20px" style="font-weight:bold; text-align: center;" colspan="13">Сведения о грузе*)</td>
            </tr>
            <tr>
                ...
                <td style="font-weight:bold; text-align: center;">Наименование продукции товара (груза) или номера контейнеров</td>
                <td style="font-weight:bold; text-align: center;">Ед. изм.</td>
...
<tr>
    ...
    <td style="font-weight:normal; text-align: center;">'.$orderItem['productName'].'</td>
    <td style="font-weight:normal; text-align: center;">шт</td>
    <td style="font-weight:normal; text-align: center;">'.$orderItem['acceptedQty'].'</td>
    <td style="font-weight:normal; text-align: center;"></td>
    <td style="font-weight:normal; text-align: center;">0</td>
    <td style="font-weight:normal; text-align: center;"></td>
    <td style="font-weight:normal; text-align: center;">305608520</td>
    <td style="font-weight:normal; text-align: center;"></td>
    <td style="font-weight:normal; text-align: center;"></td>
    <td style="font-weight:normal; text-align: center;"></td>
    <td style="font-weight:normal; text-align: center;"></td>
...
$productInOrderFooter = '<tr>
                <td style="font-weight:normal; text-align: center;"></td>
                <td style="font-weight:normal; text-align: center;"></td>
                <td style="font-weight:normal; text-align: center;">Итого</td>
                <td style="font-weight:normal; text-align: center;"></td>
...
$pdf->writeHTMLCell(0,0,0,$y+120,$productInOrder,0,1);
...
<table width="100%" style="padding:2px"  border="0">
            <tr>
                ...
                <td width="50%" style="font-weight:normal;">Отпуск разрешил _______________________________________________________</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <table width="100%" style="padding:2px"  border="0">
                        <tr>
                            ...
                            <td width="20%" style="font-weight:normal;">Кол.</td>
                        </tr>
                        <tr>
                            <td width="80%" style="font-weight:normal;">пломбой, тарой и упаковкой______________</td>
                            <td width="20%" style="font-weight:normal;">мест _одно_</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td width="100%" style="font-weight:normal; text-align: left" >Сдал ФИО И ПОДПИСЬ ответственного на складе</td>
                        </tr>
                        <tr>
                            <td width="100%" style="font-weight:normal; text-align: center" >должность,ФИО, подпись, штамп</td>
                        </tr>
                        <tr>
                            <td width="100%" style="font-weight:normal; text-align: left" >Принят водит.экспедитор ФИО И ПОДПИСЬ</td>
                        </tr>
                        <tr>
...
$pdf->writeHTMLCell(0,0,0,$y+8,$table3Cell,0,1);
