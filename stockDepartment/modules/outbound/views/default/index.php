...
<span id="buttons-menu">
    <?= Html::tag('span', Yii::t('outbound/buttons', 'Upload outbound order DeFacto API [1]'), ['class' => 'btn btn-primary btn-lg', 'style' => ' margin:10px;', 'id' => 'upload-outbound-order-api-bt']) ?>
    <?= Html::tag('span', Yii::t('outbound/buttons', 'Outbound print pick list [2]'), ['class' => 'btn btn-primary btn-lg', 'style' => ' margin:10px;', 'id' => 'outbound-print-pick-list-bt']) ?>
    <?= Html::tag('span', Yii::t('outbound/buttons', 'Begin end picking process [3]'), ['class' => 'btn btn-primary btn-lg', 'style' => ' margin:10px;', 'id' => 'begin-end-picking-list-bt']) ?>
    <?= Html::tag('span', Yii::t('outbound/buttons', 'Scanning process [4]'), ['class' => 'btn btn-primary btn-lg', 'style' => ' margin:10px;', 'id' => 'scanning-process-bt']) ?>
    <?= Html::tag('span', Yii::t('outbound/buttons', 'Download  outbound order DeFacto API [5]'), ['class' => 'btn btn-primary btn-lg', 'style' => ' margin:10px;', 'id' => 'download-outbound-order-api-bt']) ?>
</span>
...
//        console.info(boxBorderValue);
    ...
    b.on('click','#scanning-form-print-box-label-bt',function() {
        var plids = $('#scanningform-picking_list_barcode_scanned').val(),
            href = $(this).data('url'),
            form = $('#scanning-form'),
            validationUrl = $(this).data('validation-url');

        errorBase.setForm(form);

        $.post(validationUrl, {'plids' : plids}, function (result) {
