...
<?= $form->field($model, 'employee_barcode')->textInput([
    ...
    'data' => ['url'=>Url::toRoute('/outbound/colins/employee-barcode-scanning-handler')]
]); ?>
...
<?= $form->field($model, 'order_shop',
    ...
    'data' => ['url'=>Url::toRoute('/outbound/colins/order-shop-scanning-handler')]
])
?>
...
<?= $form->field($model, 'box_barcode', [
    ...
    'class' => 'form-control ext-large-input',
    'data' => ['url'=>Url::toRoute('/outbound/colins/box-barcode-scanning-handler')]
...
['labelOptions' => ['label' => Yii::t('outbound/forms', 'Product Barcode')],
    ...
    'class' => 'form-control ext-large-input',
    'data' => ['url'=>Url::toRoute('/outbound/colins/product-barcode-scanning-handler')]
