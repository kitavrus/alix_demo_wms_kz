...
<div class="get-allocate-list-form">
    ...
    <?php $form = ActiveForm::begin([
            ...
            'validationUrl'=>Url::to('/outbound/colins/validate-scanning-box'),
//            'enableAjaxValidation'=>true,
    ...
    <?= $form->field($model, 'box_barcode')->textInput([
        'data' => [
            'url'=>Url::toRoute('/outbound/colins/print-sorting-list-by-box'),
            'validation-url'=>Url::toRoute('/outbound/colins/validate-scanning-box'),
        ]
