...
namespace stockDepartment\modules\user\models;
...
//    const USER_TYPE_UNDEFINED = 0; // Тип не указан
    const USER_TYPE_CLIENT = 1; //Клиент
//    const USER_TYPE_STORE_MANAGER = 2; //Менеджер клиента
    const USER_TYPE_STOCK_WORKER = 2; //Работник склада
    const USER_TYPE_BOSS = 999; //БОСС
...
//    }
     ...
     * */
    public function getUserTypeArray($key = null)
    {
        $data = [
