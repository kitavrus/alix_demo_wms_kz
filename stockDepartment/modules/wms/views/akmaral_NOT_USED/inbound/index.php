...
<?= Html::dropDownList( 'client_id',\common\modules\client\models\Client::CLIENT_AKMARAL, $clientsArray, [
        'prompt' => '',
...
//                '{label}' => '<label for="inbound-form-party-number">' . Yii::t('inbound/forms', 'Order') . '</label>',
        ...
        ['prompt' => '',
            ...
            'class' => 'form-control input-lg',
            'data-url' => '/wms/akmaral/inbound/get-in-process-inbound-orders-by-client-id'
        ]
    ); ?>
    ...
    <?= $form->field($inboundForm, 'order_number',
        ...
        ['prompt' => '',
            ...
            'class' => 'form-control input-lg',
            'data-url' => Url::to('/wms/akmaral/inbound/get-scanned-product-by-id')
        ]
    ); ?>
    ...
    <?= $form->field($inboundForm, 'box_barcode', [
        ...
        [
            ...
            'class' => 'form-control input-lg',
            'data-url' => Url::to('/wms/akmaral/inbound/validate-scanned-box')
        ]
    ); ?>
...
//        ]
            ...
            'class' => 'form-control input-lg',
            'data-url' => Url::to('/wms/akmaral/inbound/scan-product-in-box')
        ]); ?>
    ...
    $(function(){
        ...
        $('#inbound-form-party-number').on('change',function() {
            ...
            if(party_id) {
                ...
                $.post('/wms/akmaral/inbound/get-in-process-inbound-orders-by-party-id', {'party_id': party_id}).done(function (result) {
...
//                    stopCountdown();
                    ...
                    $.post(url,  data).done(function (result) {
                        ...
                        $(messages_processText).html(' [ '+'Данные успешно загружены ] ').fadeOut( 5000,function() {
                            ...
                            window.location.href = '/wms/akmaral/inbound/index';
                        } );
