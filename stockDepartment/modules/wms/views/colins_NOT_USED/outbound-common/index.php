...
$this->title = Yii::t('outbound/titles', 'Colins Outbound')
?>
<?= Html::label(Yii::t('inbound/forms', 'Client ID')); ?>
<?= Html::dropDownList( 'client_id',\common\modules\client\models\Client::CLIENT_COLINS,$clientsArray, [
        'prompt' => '',
...
<script type="text/javascript">
    ...
    function initClientId(){
        ...
        if(client_id) {
            ...
            $.post('get-parent-order-number', {'client_id': client_id}).done(function (result) {
...
//            console.info("Value : " + $(this).val());
            ...
            if($(this).val() == 'CHANGEBOX') {
                var contentHref = '/wms/colins/outbound-common/printing-box-content',
                    boxBarcode = $('#scanningform-box_barcode'),
                    pickingList = $('#scanningform-picking_list_barcode'),
