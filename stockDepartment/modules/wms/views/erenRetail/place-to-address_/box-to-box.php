...
use yii\helpers\Url;
use stockDepartment\modules\wms\managers\erenRetail\placement\BoxToBoxFormAsset;
...
BoxToBoxFormAsset::register($this);

?>
<?php $this->title = "Из короба в короб InterMode"; ?>
<!--<a href="<?= Url::to('/wms/erenRetail/place-to-address/index')?>" class="btn btn-primary">короб на полку</a>
<a href="<?= Url::to('/wms/erenRetail/place-to-address/product-in-box-to-box')?>" class="btn btn-primary">из короба в короб поштучно</a -->
<h1><?= $this->title ?></h1>
<?= Alert::widget([
    'options' => [
        'id' => 'success-list',
