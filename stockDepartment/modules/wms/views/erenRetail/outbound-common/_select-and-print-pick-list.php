...
//		$orderNumberArray,
        ...
        <div class="form-group">
            <?= Html::tag('span', Yii::t('outbound/buttons', 'Print Picking List'), ['class' => 'btn btn-primary', 'style' => ' margin-left:10px;', 'id' => 'print-picking-outbound-print-bt','data-url-value'=>Url::to(['print-pick-list'])]) ?>
        </div>
