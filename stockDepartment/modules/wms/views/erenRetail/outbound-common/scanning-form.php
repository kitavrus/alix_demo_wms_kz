...
//        ]) ?>
   ...
   <?= Html::tag('span', Yii::t('outbound/buttons', 'PRINT_BOX_KG_LIST'), ['data-validate-url' => Url::toRoute('validate-print-box-kg-list'),'data-redirect-url' => Url::toRoute('print-box-kg-list'), 'class' => 'btn btn-warning', 'id' => 'scanning-form-print-box-kg-bt', 'style' => 'margin-left:10px;']) ?>
