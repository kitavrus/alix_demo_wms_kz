...
//            $structure_table .= '<tr align="center" valign="middle" style="background-color:'.($item['items'] == $item['count_status_scanned'] ? '#FFFFF1' : 'lightgray').'">';
            ...
            $structure_table .= '<td align="center" valign="middle" border="1">'.$item['inventory_primary_address'].'</td>';
            ...
            $structure_table .= '<td align="center" valign="middle" border="1">'.\common\modules\stock\models\Inventory::getStatusScanValue($item['status_inventory']).'</td>';
