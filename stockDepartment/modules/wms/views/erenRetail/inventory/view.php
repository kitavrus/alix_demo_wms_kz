...
<div class="inventory-view">
    ...
    <p>
        <?php if($model->status != \common\modules\stock\models\Inventory::STATUS_DONE) { ?>

            <?php if($model->status == \common\modules\stock\models\Inventory::STATUS_NEW) { ?>
