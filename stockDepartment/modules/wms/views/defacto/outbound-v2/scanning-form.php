...
<?= Html::tag('span', Yii::t('outbound/buttons', 'Print box label'), ['data-url' => Url::toRoute('printing-box-label'),'data-validate-url' => Url::toRoute('validate-printing-box-label'), 'class' => 'btn btn-danger', 'id' => 'scanning-form-print-box-label-bt', 'style' => 'margin-top:-42px; float:right; font-size: 25px;']) ?>
...
<?= $form->field($model, 'employee_barcode')->textInput([
    ...
    'data-url' => Url::toRoute('employee-barcode-scanning-handler')
]); ?>
...
<?= $form->field($model, 'picking_list_barcode',
    ...
    'data-url' => Url::toRoute('picking-list-barcode-scanning-handler')
]) ?>
...
<?= $form->field($model, 'box_barcode', [
    ...
    'parts' => [
        ...
        '{input-group-begin}' => '<div class="input-group">',
        '{input-group-end}' => '</div>',
        '{counter}' => '<div class="input-group-addon" style="font-size: 60px;">' . Yii::t('outbound/forms', 'Products') . ': <strong id="count-product-in-box" >0</strong>&nbsp;&nbsp;&nbsp;&nbsp;<span class="in-box">' . Yii::t('outbound/forms', 'In box') . ': </span></div>',
    ...
    'class' => 'form-control ext-large-input',
    'data-url' => Url::toRoute('box-barcode-scanning-handler')
...
['labelOptions' => ['label' => Yii::t('outbound/forms', 'Product Barcode')],
    ...
    'class' => 'form-control ext-large-input',
    'data-url' => Url::toRoute('product-barcode-scanning-handler')
...
<div class="row" style="margin: 20px 1px">
    ...
    <?= Html::tag('span', Yii::t('outbound/buttons', 'PRINT_BOX_KG_LIST'), ['data-validate-url' => Url::toRoute('validate-print-box-kg-list'),'data-redirect-url' => Url::toRoute('print-box-kg-list'), 'class' => 'btn btn-warning', 'id' => 'scanning-form-print-box-kg-bt', 'style' => 'float:right; font-size: 25px;']) ?>
</div>
...
<div id="outbound-items" class="table-responsive">
    <table class="table">
        <tr>
            ...
            <th><?= Yii::t('outbound/forms', 'Короб клиента'); ?></th>
