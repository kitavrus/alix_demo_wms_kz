...
\common\b2b\domains\outboundLogitrans\assets\OutboundLogiTransFormAsset::register($this);
$this->title = Yii::t('wms/titles', 'DeFacto Outbound Process')
?>
<?= Html::label(Yii::t('inbound/forms', 'Client ID')); ?>
<?= Html::dropDownList( 'client_id',\common\modules\client\models\Client::CLIENT_DEFACTO,[\common\modules\client\models\Client::CLIENT_DEFACTO=>"Defacto LTD"], [
//        'prompt' => '',
...
//    ]) ?>
    <?= Html::tag('span', Yii::t('wms/buttons', 'Outbound scanning process [{0}]', ['2']), [
        'class' => 'btn btn-primary btn-lg',
        'style' => ' margin:10px;',
        'id' => 'scanning-process-bt',
        'data-url' => Url::toRoute('scanning-form')
    ]) ?>
<!--    --><?//= Html::a(Yii::t('/other/api-de-facto/buttons', 'Если не вышла'),'/wms/defacto/outbound-v2/list-for-print-box-label', [
