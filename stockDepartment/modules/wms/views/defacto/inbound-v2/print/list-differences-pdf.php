...
$structure_table = '<table width="100%" cellspacing="0" cellpadding="4" border="1">' .
    ...
    '      <th width="10%" align="center" valign="middle" border="1"><strong>' . Yii::t('inbound/forms','Product Model') . '</strong></th>' .
    '      <th width="15%" align="center" valign="middle" border="1"><strong>' . Yii::t('inbound/forms','Client box') . '</strong></th>' .
    ...
    foreach ($items as $item) {
        if($item['expected_qty'] != $item['accepted_qty']) {
            $structure_table .= '<tr align="center" valign="middle" style="background-color:' . ($item['expected_qty'] == $item['accepted_qty'] ? '#FFFFF1' : 'lightgray') . '">
                ...
                <td align="center" valign="middle" border="1">' . $item['box_barcode'] . '</td>
