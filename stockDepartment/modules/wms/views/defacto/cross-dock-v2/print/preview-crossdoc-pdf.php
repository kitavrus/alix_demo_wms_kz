...
$html .='<table width="60%" style="padding:2px">
            <tr>
                <td width="100%"><h1>Предпросмотр нового Сross-Dock</h1></td>
            </tr>
             <tr>
...
if($crossOrders){
    foreach($crossOrders as $co) {
           ...
           $html .=
               '<tr>
                    <th width="40%" style="font-weight:normal;">'.$co['store'].'</th>
...
$html .='<table width="80%" style="padding:2px;" border="1" align="left">';
$html.= '<tr>
            <th width="40%" style="font-weight-:normal;">Итого CROSS-DOCK</th>
