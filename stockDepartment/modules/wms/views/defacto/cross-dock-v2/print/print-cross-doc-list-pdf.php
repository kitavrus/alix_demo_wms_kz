...
$html ='<table width="100%" style="padding:2px;" border="1" align="left">
            <tr>
...
if($crossOrders){
    foreach($crossOrders as $co) {
       if($store = $co->pointTo) {
           ...
           $html .=
               '<tr>
                    <th width="40%" style="font-weight:normal;">'.$store->getPointTitleByPattern('{shopping_center_name} / {city_name} / {shop_code}').'</th>
