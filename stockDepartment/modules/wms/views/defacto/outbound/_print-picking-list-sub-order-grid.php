        ...
        [
          'attribute'=>  'to_point_title',
            'value'=>function ($model) {
                ...
                $store = Store::find()
                    ->andWhere(['id'=>$model->to_point_id])
//                    ->andWhere(['deleted'=>0])
//                    ->orWhere(['shop_code'=>$model->to_point_title])
//                    ->orWhere(['shop_code2'=>$model->to_point_title])
//                    ->orWhere(['shop_code3'=>$model->to_point_title])
//                    ->andWhere(['shop_code3'=>$model->to_point_title])
                ->one();
                if($store){
