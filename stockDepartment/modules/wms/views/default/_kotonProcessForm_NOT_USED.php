...
<!--    --><?//= Html::tag('span', Yii::t('outbound/buttons', 'Print allocation list [1]'), ['data'=>['url'=>Url::toRoute('/wms/colins/outbound/scanning-box')],'class' => 'btn btn-primary btn-lg', 'style' => ' margin:10px;', 'id' => 'scanning-box-colins-bt']) ?>
<!--    --><?//= Html::tag('span', Yii::t('outbound/buttons', 'TIR scanning process [2]'), ['data'=>['url'=>Url::toRoute('/wms/colins/outbound/scanning-form')],'class' => 'btn btn-primary btn-lg', 'style' => ' margin:10px;', 'id' => 'scanning-process-colins-bt']) ?>
<!--    --><?//= Html::tag('span', Yii::t('outbound/buttons', 'Inbound [3]'), ['data'=>['url'=>Url::toRoute('/wms/koton/inbound/inbound-form')],'class' => 'btn btn-primary btn-lg', 'style' => ' margin:10px;', 'id' => 'inbound-process-koton-bt']) ?>
    <?= Html::a(Yii::t('outbound/buttons', 'Inbound [3]'), Url::toRoute('/wms/koton/inbound/index'),['class' => 'btn btn-primary btn-lg', 'style' => ' margin:10px;']) ?>
    <?= Html::a(Yii::t('outbound/buttons', 'Outbound [4]'), Url::toRoute('/wms/koton/outbound-common/index'),['class' => 'btn btn-primary btn-lg', 'style' => ' margin:10px;']) ?>
</span>
