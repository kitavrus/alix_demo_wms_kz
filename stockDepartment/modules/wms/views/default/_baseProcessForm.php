...
<span id="buttons-menu">
    <?= Html::a(Yii::t('outbound/buttons', 'Приход'), Url::toRoute(['/wms/baseTemplate/inbound/index','client_id'=>$id]),['class' => 'btn btn-primary btn-lg', 'style' => ' margin:10px;']) ?>
    <?= Html::a(Yii::t('outbound/buttons', 'Расход'), Url::toRoute(['/wms/baseTemplate/outbound/index','client_id'=>$id]),['class' => 'btn btn-primary btn-lg', 'style' => ' margin:10px;']) ?>
</span>
