...
\stockDepartment\modules\wms\assets\carParts\main\PlaceToAddressFormAsset::register($this);

?>
<?php $this->title = "Размещение товара в адрес на полке"; ?>
<a href="<?= Url::to('/wms/carParts/main/place-to-address/box-to-box')?>" class="btn btn-primary">из короба в короб</a>
<h1><?= $this->title ?></h1>
