...
use stockDepartment\modules\stock\assets\InventoryAsset;
use yii\helpers\Url;
...
<div class="stock-accommodation-form">
    ...
    <?= $form->field($InventoryForm, 'inventory_id')->dropDownList(\common\modules\stock\models\Inventory::getActiveInventory()) ?>

    <?= $form->field($InventoryForm, 'secondary_address'
//		,[
...
//	]
    ...
    <?= $form->field($InventoryForm, 'primary_address', [
