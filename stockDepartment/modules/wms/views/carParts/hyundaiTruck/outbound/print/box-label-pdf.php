...
/* @var $mappingOurBobBarcodeToDefacto Array */

////Yii::$app->get('tcpdf');;;

$managersNamesTo = '';

$outboundOrderModel = $dto->order;
$model = \common\modules\transportLogistics\models\TlDeliveryProposal::findOne($dp->id);
//$model = $dp;
...
$recipientText =  $city . ' '. $routeTo->name . ' ' . $routeTo->street. ' '.$routeTo->house;
...
//\yii\helpers\VarDumper::dump($mappingOurBobBarcodeToDefacto,10,true);
//die;
...
//	$params['senderText'] =  'ТОО "Subaru Kazakhstan . СубПод:"'.$senderText;
	...
	$params['outboundOrderNumber'] = $outboundOrderModel->parent_order_number.' '.$outboundOrderModel->order_number;
