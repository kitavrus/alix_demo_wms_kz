...
$pdf->writeHTMLCell('67', '8', 25, 75, $boxBarcode,false);
$pdf->write1DBarcode($lotBarcode, 'C128', 0, 85, '60', 15, 1.5, $style, 'C');

$pdf->lastPage();

$dirPath = 'uploads/box-labels/'.date('Ymd').'/'.date('His');
$fileName = Yii::$app->getSecurity()->generateRandomString(12). 'return-box-label.pdf';
...
if(file_exists($fullPath)){
	...
	$boxLabel->client_id = $model->client_id;
	$boxLabel->return_order_id = $model->id;
	$boxLabel->outbound_order_number = $model->order_number;
...
echo \yii\helpers\Json::encode([
	'success' =>'1',
	'labelUrl' => \yii\helpers\Url::toRoute(['/outbound/outbound-box-labels/download-label-pdf','id'=>$boxLabel->id])
]);