...
<div class="return-order-process-form">
    ...
    <?= $form->field($model, 'box_barcode', [
        ...
        'parts' => [
            ...
            '{button-right}' => '<div class="input-group-addon" style="background-color: none; border: none; border-radius: none;" ><span class="btn btn-success btn-xs" data-url="' . Url::toRoute(['clear-all-in-box']) . '" id="clear-box-return-bt">' . Yii::t('return/buttons', 'Clear Box') . '</span></div>'
        ]
    ])->textInput([
    ...
    <?= $form->field($model, 'product_barcode',
        ['labelOptions' => ['label' => Yii::t('return/forms', 'Product Barcode')],
            ...
            'parts' => [
                ...
                '{input-group-begin}' => '<div class="input-group">',
                '{input-group-end}' => '</div>',
                '{button-right}' => '<div class="input-group-addon" style="background-color: none; border: none; border-radius: none;" ><span class="btn btn-success btn-xs" data-url="' . Url::toRoute(['clear-product-in-box-by-one']) . '" id="clear-product-in-box-by-one-scanning-return-bt">' . Yii::t('return/buttons', 'Clear product in box') . '</span></div>'
            ]
        ]
    )->textInput(
        [
            'class' => 'form-control ext-large-input',
            'data' => ['url'=>Url::toRoute('scan-product-from-box')]
        ]
