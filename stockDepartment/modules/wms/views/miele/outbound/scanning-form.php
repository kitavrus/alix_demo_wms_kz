...
\stockDepartment\modules\wms\assets\Miele\ScanFormOutboundAsset::register($this);

?>
<h1>Отгрузка MIELE</h1>
...
<div class="scanning-form">
    ...
    <?= $form->field($model, '_on_print_box_label')->hiddenInput(['value'=>0])->label(false)->error(false); ?>
