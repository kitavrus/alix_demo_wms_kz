...
$structure_table = '<table width="100%" cellspacing="0" cellpadding="4" border="1">' .
    ...
    '      <th width="20%" align="center" valign="middle" border="1"><strong>' . Yii::t('outbound/forms','New address') . '</strong></th>' .
    '      <th width="20%" align="center" valign="middle" border="1"><strong>' . Yii::t('outbound/forms','Old address') . '</strong></th>' .
    ...
    '      <th width="20%" align="center" valign="middle" border="1"><strong>' . Yii::t('outbound/forms','Fab number') . '</strong></th>' .
    '   </tr>';
$exp = $acc = 0;
if (!empty($diffItems->items)) {
    foreach ($diffItems->items as $item) {
        $structure_table .= '<tr align="center" valign="middle" style="background-color:lightgray">
                <td align="center" valign="middle" border="1">-</td>
                <td align="center" valign="middle" border="1">-</td>
                <td align="left" valign="middle" border="1">' . $item->productBarcode . '</td>
                <td align="center" valign="middle" border="1">' . $item->expectedQty . '</td>
                <td align="center" valign="middle" border="1">' . $item->acceptedQty . '</td>
                <td align="center" valign="middle" border="1">' . $item->fabBarcode . '</td>
            </tr>';

        foreach ($item->scannedItems as $scannedItem) {
            $structure_table .=
                '<tr align="center" valign="middle" style="background-color: #FFFFFF">
                            <td align="center" valign="middle" border="1">' . $scannedItem->oldAddress . '</td>
                            <td align="center" valign="middle" border="1">' . $scannedItem->newAddress . '</td>
                            <td align="left" valign="middle" border="1">' . $item->productBarcode . '</td>
                            <td align="center" valign="middle" border="1">' . $item->expectedQty . '</td>
                            <td align="center" valign="middle" border="1">' . $item->acceptedQty . '</td>
                            <td align="center" valign="middle" border="1">' . $item->fabBarcode . '</td>
