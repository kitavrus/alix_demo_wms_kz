...
foreach ($boxes as $iBox=>$barcode) {
	...
	$params['outboundOrderNumber'] = $outboundOrder->parent_order_number.' '.$outboundOrder->order_number;
...
if(file_exists($fullPath)){
	...
	$boxLabel->client_id = $outboundOrder->client_id;
	$boxLabel->outbound_order_id = $outboundOrder->id;
	$boxLabel->outbound_order_number = $outboundOrder->order_number;
