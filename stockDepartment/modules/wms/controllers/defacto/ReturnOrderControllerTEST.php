...
//            if($byProduct) {
//                if($apiResponse['response']->KoliIadeKabulResult->MessageCode != '000') {
//                    $params = [
//                        'request' => [
//                            'UserName' => '',
//                            'Password' => '',
...
//            $errors[] = ['returnformnew-order_number'=> [Yii::t('return/messages', 'Для этой накладной уже напечатали этикетку или вы не выбрали накладную')]];
        ...
        $dataReturn =  $this->renderPartial('print/_box-label-pdf', ['model' => $model,'koliResponseData'=>$koliResponseData]);
