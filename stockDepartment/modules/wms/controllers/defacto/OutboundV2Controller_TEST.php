                        ...
                        if($tmp = DeFactoSoapAPIV2Manager::preparedSendOutBoundFeedBackData($stocks,$outboundOrderItem)) {
                            foreach($tmp as $tmpAPIValue) {
                                if(!isset($mappingOurBobBarcodeToDefacto[$tmpAPIValue['LcBarcode']])) {
                                    ...
                                    $mappingWaybillNumber[$tmpAPIValue['LcBarcode']] = DeFactoSoapAPIV2Manager::makeWaybillNumber($outboundOrderModel->id,$boxCountStep);
                                    $boxCountStep++;
//                                    file_put_contents("mappingOurBobBarcodeToDefactoXXX.csv",
...
//                        foreach ($rowsDataForAPI['OutBoundFeedBackThreePLResponse'] as $dataForFile) {
//                            file_put_contents("2436-14311.csv",
//                            file_put_contents("929-14311.csv",
//                            file_put_contents("820-14311.csv",
                            //file_put_contents("889-14311.csv",
//                            file_put_contents("930-14311.csv",
//                            file_put_contents("978-14311.csv",
//                            file_put_contents("820-14482.csv",
//                            file_put_contents("930-14889.csv",
//                            file_put_contents("820-14889.csv",
//                            file_put_contents("820-15092.csv",
//                            file_put_contents("889-15092.csv",
//                            file_put_contents("978-15092.csv",
//                                $outboundOrderModel->id.";"
//                                .$dataForFile['LcBarcode'].";"
//                                .$dataForFile['WaybillNumber'].";"
//                                .$dataForFile['our_box_barcode'].";"
//                                .$dataForFile['LotOrSingleBarcode'].";"
//                                ."\n",FILE_APPEND);
//                        }


//                        file_put_contents('SendOutBoundFeedBackData-rowsDataForAPI.csv',print_r($rowsDataForAPI,true)."\n"."\n",FILE_APPEND);
                        file_put_contents('SendOutBoundFeedBackData-serialize-rowsDataForAPI.csv',serialize($rowsDataForAPI)."\n"."\n",FILE_APPEND);
                    }
                }
