...
use common\clientObject\main\inbound\forms\ScanInboundForm;
...
class InboundController extends Controller
{
    ...
    { // scan-transported-box-barcode
        ...
        if ($inboundForm->load(Yii::$app->request->post()) && $inboundForm->validate()) {
            $inboundOrderService = new \common\clientObject\main\inbound\service\InboundOrderService($inboundForm->getDTO());
    ...
    public function actionPrintDiffInOrder()
    {
        ...
        $inboundOrderService = new \common\clientObject\main\inbound\service\InboundOrderService();
