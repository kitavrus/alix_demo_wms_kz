...
//					}
			...
			return $data['order_number'];//.' -> '.$store;
		});

//        VarDumper::dump($partyNumberArray,10,true);
//        die;
...
//			$post['InboundForm']['product_barcode'] = "0".$post['InboundForm']['product_barcode'];
...
//                $inbound->status = InboundOrder::STATUS_COMPLETE_BY_API;
   ...
   * */
	public function actionScanProductManual()
	{
		...
		die(" /wms/erenRetail/inbound/scan-product-manual DIE ");
		$model1 = new \stdClass();
