...
use stockDepartment\modules\wms\managers\erenRetail\checkBox\entities\CheckBoxInventorySearch;
...
class CheckBoxInventoryController extends Controller
{
    ...
    {
        $searchModel = new CheckBoxInventorySearch();
...
//    }
    ...
    {
        if (($model = CheckBoxInventory::findOne($id)) !== null) {
            return $model;
        }
