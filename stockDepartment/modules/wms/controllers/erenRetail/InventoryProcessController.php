...
use stockDepartment\modules\wms\managers\erenRetail\inventory\InventoryForm;
use Yii;
...
//use app\modules\stock\models\InventorySearch;
use stockDepartment\modules\wms\managers\erenRetail\inventory\Inventory;
...
//							 	'secondary_address'=>$minMax,
							...
							->andWhere('secondary_address LIKE "'.$minMax.'%" ')
							->all();
...
//                    $invRow->expected_places_qty = $stockRowBoxQty;
                ...
                Stock::updateAll([
                    ...
                    'secondary_address LIKE "'.$minMax.'%" AND inventory_id = :inventory_id',
					[':inventory_id'=>$inventoryForm->inventory_id]
                );
            }
    ...
    public function actionPrimaryAddress()
    {
        ...
        if ($inventoryForm->load(Yii::$app->request->post()) && $inventoryForm->validate()) {
            ...
            if(!Stock::find()
					 ->andWhere([
					 	'inventory_primary_address'=>$inventoryForm->primary_address,
						// 'secondary_address'=>$minMax,
						 'status_inventory'=>Inventory::STATUS_SCAN_PROCESS,
						 'inventory_id'=>$inventoryForm->inventory_id
					 ])
...
//            if(BarcodeManager::isBoxLotOrReturnBox($productBarcode,$minMax,$inventoryForm->primary_address)) {
...
//						 'secondary_address'=>$minMax,
            ...
            if(!$inventoryForm->hasErrors()) {
				...
				primary_address = :primary_address AND
				inventory_id = :inventory_id AND
				status_inventory = :status_inventory AND
				secondary_address LIKE "'.$minMax.'%" 
				'
//					'primary_address'=>$inventoryForm->primary_address,
//					'secondary_address'=>$minMax,
//					'inventory_id'=>$inventoryForm->inventory_id,
//					'status_inventory' =>Inventory::STATUS_SCAN_YES
//				]
