...
//        $this->findModel($id)->delete();
    ...
    public function actionPrintFullReportExcel($id)
    {
        ...
        $items = Stock::find()
			...
			->andWhere("status_inventory != 2")
            ->groupBy('product_barcode,inventory_primary_address, primary_address, inventory_secondary_address, secondary_address')
            ->orderBy([
...
//                'secondary_address'=>SORT_DESC,
    ...
    {
        $model = $this->findModel($id);
        $condition = ['inventory_id'=>$model->id,'client_id'=>Client::CLIENT_ERENRETAIL,'status_inventory'=>[Inventory::STATUS_SCAN_NO,Inventory::STATUS_SCAN_PROCESS]];
