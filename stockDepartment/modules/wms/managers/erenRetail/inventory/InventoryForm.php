...
//use stockDepartment\modules\wms\managers\erenRetail\inventory\BarcodeManager;
...
class InventoryForm extends Model {
    ...
    private $inventoryFileNameError = 'inventory20140904.csv';
...
//        $minMax = Inventory::getMinMaxSecondaryAddress($this->secondary_address);
