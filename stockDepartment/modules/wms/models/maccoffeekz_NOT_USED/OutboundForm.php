...
class OutboundForm extends Model {
    ...
    {
        return [
            [['picking_list_barcode_scanned','employee_barcode','picking_list_barcode','box_barcode','product_barcode','step'], 'trim'],
            [['picking_list_barcode_scanned','employee_barcode','picking_list_barcode','box_barcode','product_barcode'], 'string'],
            [['step'], 'integer'],
