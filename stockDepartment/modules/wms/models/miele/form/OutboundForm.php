...
use stockDepartment\modules\wms\models\miele\validation\ValidationOutbound;
use yii\base\Model;
use Yii;
...
class OutboundForm extends Model {
    ...
    {
        return [
            [['fub_barcode','employee_barcode','pick_list_barcode','box_barcode','product_barcode'], 'trim'],
            [['fub_barcode','employee_barcode','pick_list_barcode','box_barcode','product_barcode'], 'string'],
            // Employee
            ...
            // Fub
            [['fub_barcode'],'IsFubBarcode', 'on'=>'onFubBarcode'],
//            [['product_barcode'],'IsProductBarcode', 'on'=>'onFubBarcode'],
            [['product_barcode'],'required', 'on'=>'onFubBarcode'],
            [['box_barcode'],'required', 'on'=>'onFubBarcode'],
            [['pick_list_barcode'],'required', 'on'=>'onFubBarcode'],
            [['employee_barcode'],'required', 'on'=>'onFubBarcode'],
            // Clean box
