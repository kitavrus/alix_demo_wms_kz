...
/* @var $inboundForm stockDepartment\modules\alix\controllers\inbound\returns\domain\InboundForm */
    ...
    <?= $form->field(
        ...
        [
            ...
            [
                ...
                'data-url' => Url::to(
                    ['/alix/inbound/returns/scanning/get-scanned-product-by-id']
                ),
            ]
        ); ?>
    ...
    <?= $form->field(
        ...
        [
            ...
            [
                ...
                'class' => 'form-control input-lg',
                'data-url' => Url::to(
                    '/alix/inbound/returns/scanning/validate-scanned-box'
                )
            ]
        ); ?>
    ...
    <?= $form->field(
        ...
        [
            ...
            [
                ...
                'class' => 'form-control input-lg',
                'data-url' => Url::to(
                    '/alix/inbound/returns/scanning/scan-product-in-box'
                )
            ]
        ); ?>
