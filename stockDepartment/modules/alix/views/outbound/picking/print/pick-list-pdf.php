...
//        $pdf->write1DBarcode($orderID.'-'.$orderNumber, 'C128', '', '', 270, 20, 0.4, $style, 'M'); // T M B N
        ...
        foreach ($productsInOrder as $rowOnStock) {
                $structure_table .= '<tr align="center" valign="middle">' .
                    ...
                    '<td align="left" valign="middle" border="1">' .$rowOnStock['productBarcode']. '</td>' .
                    '<td align="left" valign="middle" border="1">' .$rowOnStock['productQty']. '</td>' .
					'<td align="left" valign="middle" border="1">' .$rowOnStock['productName']. '</td>' .
					'<td align="left" valign="middle" border="1">' .$rowOnStock['productColor']." / ".$rowOnStock['productBrand']. '</td>' .
					'</tr>';
        }
