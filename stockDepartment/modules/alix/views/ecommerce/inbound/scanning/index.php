...
/* @var $partyNumberArray common\ecommerce\entities\EcommerceInbound */
...
stockDepartment\modules\alix\controllers\ecommerce\inbound\domain\assets\InboundAsset::register($this);
?>
...
<div class="order-process-form">
    ...
    <?= $form->field($inboundForm, 'party_number',
        ...
        [
            ...
            'data-url' => '/alix/ecommerce/inbound/scanning/get-in-process-inbound-orders-by-party-id'
        ]
    ); ?>
    ...
    <?= $form->field($inboundForm, 'order_number',
        ...
        [
            ...
            'class' => 'form-control input-lg',
            'data-url' => Url::to('/alix/ecommerce/inbound/scanning/get-scanned-product-by-id')
        ]
    ); ?>
    ...
    <?= $form->field($inboundForm, 'box_barcode', [
        ...
        'class' => 'form-control input-lg',
        'data-url' => Url::to('/alix/ecommerce/inbound/scanning/validate-scanned-box')
    ]); ?>
    ...
    <?= $form->field($inboundForm, 'product_barcode',
        [
            ...
            'class' => 'form-control input-lg',
            'data-url' => Url::to('/alix/ecommerce/inbound/scanning/scan-product-in-box')
        ]); ?>
    ...
    <?= Html::tag('span', Yii::t('inbound/buttons', 'Accept') . '<span id="inbound-messages-process"> </span>', ['class' => 'btn btn-danger pull-right', 'data-url' => Url::toRoute('/alix/ecommerce/inbound/scanning/confirm-order'), 'style' => ' margin-left:10px;', 'id' => 'inbound-accept-bt']) ?>
</div>
