...
\stockDepartment\modules\intermode\controllers\outboundSeparator\domain\assets\ScanOutboundSeparatorFormAsset::register($this);
?>
    ...
    <?= $form->field($model, 'box_barcode'
        ...
        ['template' => "{label}\n{input-group-begin}{button-right}{input}{input-group-end}\n{hint}\n{error}\n",
            'parts' => [
                '{input-group-begin}' => '<div class="input-group">',
                '{input-group-end}' => '</div>',
                '{button-right}' => '<div class="input-group-addon" style="font-size: 62px;" id="box-barcode-info">0/0</div>'
            ]
        ]
    )->textInput([
        'class' => 'form-control ext-large-input',
