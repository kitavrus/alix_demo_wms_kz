...
namespace stockDepartment\modules\alix\controllers\ecommerce\outbound\domain\form;

use stockDepartment\modules\alix\controllers\ecommerce\outbound\domain\OutboundListService;
use yii\base\Model;
use Yii;
...
class OutboundListForm extends Model
{
	...
	const SCENARIO_SHOW_KASPI_WAITING_LABEL = 'SHOW-KASPI-WAITING-LABEL';
