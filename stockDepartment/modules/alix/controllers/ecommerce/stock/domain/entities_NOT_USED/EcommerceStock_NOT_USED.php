...
namespace stockDepartment\modules\intermode\controllers\ecommerce\stock\domain\entities;
 ...
 * @property int $inbound_datamatrix_id ID
 * @property string $inbound_datamatrix_code QR товара inbound
...
class EcommerceStock extends \common\models\ActiveRecord
{
    ...
    public function rules()
    {
        return [
			...
			[['inbound_datamatrix_code',], 'string'],
			[['inbound_datamatrix_id',], 'integer'],
        ];
    }
