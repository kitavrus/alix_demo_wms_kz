 ...
 * @property int $total_counter Счетчик по достижению которого можно закрывать накладную
...
class CronManager extends ActiveRecord
{
    ...
    {
        return [
            [['order_id', 'created_user_id', 'updated_user_id', 'created_at', 'updated_at', 'deleted','total_counter'], 'integer'],
