...
namespace stockDepartment\modules\alix\controllers\outbound;

use stockDepartment\components\Controller;
use stockDepartment\modules\alix\controllers\outbound\domain\OutboundForm;
use stockDepartment\modules\alix\controllers\outbound\domain\OutboundScanningService ;
use Yii;
	...
	* */
    ...
    { // /ecommerce/intermode/outbound/scanning/package?id=430
		...
		if($isError) {
			...
			return $this->redirect('/alix/outbound/scanning/scanning-form');
		}
		...
		if ($outbound !== null
			...
			return $this->redirect([
				'/alix/outbound/scanning/scanning-form',
	 ...
	 *
	 * /alix/outbound/scanning/kaspi-label?orderNumber=KASPI-ODk2ODg0NjEw
	 */
