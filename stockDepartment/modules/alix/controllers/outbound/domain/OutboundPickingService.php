...
class OutboundPickingService
{
	...
	public function __construct()
	{
		...
		//$this->apiService = new \stockDepartment\modules\alix\controllers\outbound\domain\mock\OutboundAPIService();
		$this->apiService = new \stockDepartment\modules\alix\controllers\outbound\domain\OutboundAPIService();
	}
	/**
	 * @param void
