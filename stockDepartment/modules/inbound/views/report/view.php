...
<div class="report-order-view">
	...
	<?= Html::a(Yii::t('transportLogistics/buttons','Print Data Matrix'),Url::to(['print-data-matrix','id'=>$model->id]),['class' => 'btn btn-info','id'=>'report-order-export-plus-product-btn', 'data-url'=>'/report/outbound/export-to-excel-plus-product']) ?>
    <?= Html::a(Yii::t('buttons', 'Placement data'), ['report/placement-data', 'id' => $model->id], ['class' => 'btn btn-warning', 'id' => 'placement-data-btn']) ?>
    <?= Html::a(
            Yii::t('buttons', 'Placement data to Excel'),
            ['export-placement-data', 'id' => $model->id],
            [
...
<?= html::a(
	yii::t('titles', 'Повторно отправить накладную по API'),
	["/intermode/default/resend-inbound-status-complete", "id" => $model['id']],
	['class' => 'btn btn-warning  pull-left',
		'data' => [
			'confirm' => yii::t('titles', 'Вы действительно хотите Повторно отправить накладную по API?'),
			'method' => 'post',
		],
	]
);
...
<?= html::a(
	...
	["/inbound/report/delete-order", "id" => $model['id']],
