...
<?php if ($step==2) { ?>
    ...
    <div class="colins-process-form-step-2">
        ...
        <div class="form-group">
            <?= Html::submitButton(Yii::t('buttons', 'Upload'), ['class' => 'btn btn-primary']) ?>
            <?= Html::a(Yii::t('buttons', 'Сбросить'), 'index', ['class' => 'btn btn-warning']) ?>
        </div>
        <?php ActiveForm::end(); ?>
    </div>
<?php } ?>
...
<?php if ($step==3) { ?>
    <div class="panel panel-warning">
        ...
        <div class="panel-body">
            <?= Html::button(Yii::t('buttons', 'Upload file(s) in system'), ['class' => 'btn btn-danger', 'id' => 'confirm-upload-bt', 'data-url' => 'process-confirm']) ?>
        </div>
