...
<?php foreach($productListInBox as $productRow)  { ?>
    <tr class="<?= \stockDepartment\modules\wms\managers\erenRetail\checkBox\constants\CheckBoxStatus::getCssClass($productRow['status']); ?>">
        <td><?= \stockDepartment\modules\wms\managers\erenRetail\checkBox\constants\CheckBoxStatus::getValue($productRow['status']); ?></td>
