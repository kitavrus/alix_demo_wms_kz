...
$this->title = Yii::t('wms/titles', 'Distribution || Colins')
?>
...
<span id="buttons-menu">
    ...
    <?= Html::tag('span', Yii::t('outbound/buttons', 'Inbound [3]'), ['data'=>['url'=>Url::toRoute('/wms/colins/inbound/inbound-form')],'class' => 'btn btn-primary btn-lg', 'style' => ' margin:10px;', 'id' => 'inbound-process-colins-bt']) ?>
    <?= Html::a(Yii::t('outbound/buttons', 'Outbound [4]'), Url::toRoute('/wms/colins/outbound-common/index'),['class' => 'btn btn-primary btn-lg', 'style' => ' margin:10px;']) ?>
</span>
