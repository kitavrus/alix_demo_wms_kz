...
<!--    --><?//= Html::tag('span', Yii::t('outbound/buttons', 'Inbound [3]'), ['data'=>['url'=>Url::toRoute('/warehouseDistribution/koton/inbound/inbound-form')],'class' => 'btn btn-primary btn-lg', 'style' => ' margin:10px;', 'id' => 'inbound-process-koton-bt']) ?>
    <?= Html::a(Yii::t('outbound/buttons', 'Inbound [3]'), Url::toRoute('/wms/tupperware/inbound/index'),['class' => 'btn btn-primary btn-lg', 'style' => ' margin:10px;']) ?>
    <?= Html::a(Yii::t('outbound/buttons', 'Outbound [4]'), Url::toRoute('/wms/tupperware/outbound-common/index'),['class' => 'btn btn-primary btn-lg', 'style' => ' margin:10px;']) ?>
</span>
