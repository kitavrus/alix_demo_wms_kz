...
use stockDepartment\modules\wms\models\erenRetail\form\ScanningForm;
use Yii;
...
//        }
    ...
    * */
    ...
    public function actionSelectAndPrintPickingList()
    {
        ...
        $outboundForm->client_id = Client::CLIENT_ERENRETAIL;
        $clientsArray = Client::getActiveItems();
...
//		if ($post['ScanningForm']['order_number'] == 71227) {
...
//        $allocated_qty =
    ...
    public function actionPrintingBoxContent()
    {
        ...
        // wms20.local/wms/koton/outbound-common/printing-box-content?box_barcode=700000091954
        // wms20.local/wms/koton/outbound-common/printing-box-content?box_barcode=700000092053
        // wms20.local/wms/koton/outbound-common/printing-box-content?box_barcode=700000091537
        // wms20.local/wms/koton/outbound-common/printing-box-content?box_barcode=700000083529
        // wms20.local/wms/koton/outbound-common/printing-box-content?box_barcode=700000083540
        // wms20.local/wms/koton/outbound-common/printing-box-content?box_barcode=700000085128
        // $items = [];
...
//        }
	...
	* */
	public function actionSaveBoxKg()
	{
		...
		$model = new \stockDepartment\modules\outbound\models\ScanningForm();
