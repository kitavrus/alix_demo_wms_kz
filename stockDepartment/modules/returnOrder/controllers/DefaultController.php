...
//            die('---STOP---');
            ...
            if( empty($apiResponse['errors']) ) {
                ...
                if(!$apiResponse['response']->GetKoliResult->IslemBasarili) {
                    $model->addError('returnform-order_number',$apiResponse['response']->GetKoliResult->Message);
                    // TODO Send Mail to Admin (Kitavrus)
                } else {

                    $koliResponse = $apiResponse['response']->GetKoliResult->Koli;
                    ...
                    foreach ($koliResponse->KoliDetay->KzkDCIadeDetay as $product) {
...
//                    $responseAPIErrorMessage = $apiResponse['response']->GetKoliResult->Message;
...
//                Yii::$app->getSession()->setFlash('error', $responseAPIErrorMessage);
