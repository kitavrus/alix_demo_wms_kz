 ...
 */
?>
<h4>Что в заказе:  <?= $dto->cancelKey; ?></h4>
<h4>Всего заказов:  <?= $items->countTotalOrders; ?></h4>
<h4>Всего товаров:  <?= $items->countTotalProducts; ?></h4>
<table class="table table-bordered">
    ...
    <?php $totalQty = count($items->items); ?>
    <?php foreach($items->items as $key=>$productRow)  { ?>
