...
<?= \yii\helpers\Html::a('<h1 class="text-left" style="padding-left: 1%">'.Yii::t('buttons', 'Отчет остатки').'</h1>','/ecommerce/defacto/report/on-stock', ['class' => 'btn btn-lg btn-default btn-block text-large','style'=>"padding:0px"]) ?>
