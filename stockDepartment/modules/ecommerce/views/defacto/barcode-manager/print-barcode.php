...
<div class="print-any-barcode-form">
    ...
    <?= $form->field($printBarcodeForm, 'codebook_id')->dropDownList(ArrayHelper::map(\common\ecommerce\entities\EcommerceBarcodeManager::find()->all(),'id','title')) ?>
...
<script type="text/javascript">
    $(function(){
        $('#print-barcode-form').on('beforeSubmit', function(){
            ...
            window.location.href = '/ecommerce/defacto/barcode-manager/print-barcode-pdf/?codebook_id='+codebook_id+'&qty='+qty;
            return false;
        });
    });
</script>