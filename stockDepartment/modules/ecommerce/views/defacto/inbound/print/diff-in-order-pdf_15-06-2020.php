...
if (!empty($items)) {
    foreach ($items as $item) {
            $structure_table .= '<tr align="center" valign="middle" style="background-color:' . ($item['productExpectedQty'] == $item['productAcceptedQty'] ? '#FFFFF1' : 'lightgray') . '">
                <td align="left" valign="middle" border="1">-</td>
                <td align="left" valign="middle" border="1">-</td>
                <td align="left" valign="middle" border="1">' . $item['clientBoxBarcode'] . '</td>
                <td align="center" valign="middle" border="1">-</td>
                <td align="center" valign="middle" border="1">-</td>
                <td align="center" valign="middle" border="1">' . $item['productExpectedQty'] . '</td>
                <td align="center" valign="middle" border="1">' . $item['productAcceptedQty'] . '</td>
            </tr>';

        foreach ($item['productList']  as $productList) {


//            $structure_table .= '<tr align="center" valign="middle" style="background-color:' . ($productList['product_expected_qty'] == $productList['product_accepted_qty'] ? '#FFFFF1' : 'lightgray') . '">
//                <td align="left" valign="middle" border="1">-</td>
//                <td align="left" valign="middle" border="1">-</td>
//                <td align="left" valign="middle" border="1">' . $productList['client_box_barcode'] . '</td>
//                <td align="center" valign="middle" border="1">-</td>
//                <td align="center" valign="middle" border="1">-</td>
//                <td align="center" valign="middle" border="1">' . $productList['product_expected_qty'] . '</td>
//                <td align="center" valign="middle" border="1">' . $productList['product_accepted_qty'] . '</td>
//            </tr>';



            $stockService = new common\ecommerce\defacto\stock\service\Service;
            $productListOnPlaces = $stockService->getItemsForDiffReportByOrderId($productList['inbound_id'], $productList['product_barcode'], $productList['lot_barcode'], $productList['client_box_barcode']);

            if ($productListOnPlaces) {
                foreach ($productListOnPlaces as $value) {

                    if($productList['product_expected_qty'] == $value['items'] && $productList['product_accepted_qty'] == $value['items']) {
                        continue;
                    }
                ...
                $structure_table .= '<tr align="center" valign="middle">
                            <td align="left" valign="middle" border="1">' . $productList['product_barcode'] . '</td>
                            <td align="center" valign="middle" border="1">-</td>
                            <td align="center" valign="middle" border="1">' . $productList['client_box_barcode'] . '</td>
                            <td align="center" valign="middle" border="1">-</td>
                            <td align="center" valign="middle" border="1">-</td>
                            <td align="center" valign="middle" border="1">' . $productList['product_expected_qty'] . '</td>
                            <td align="center" valign="middle" border="1">' . $productList['product_accepted_qty'] . '</td>
