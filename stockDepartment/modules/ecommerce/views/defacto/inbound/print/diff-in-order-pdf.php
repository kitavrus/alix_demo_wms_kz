...
if (!empty($items)) {
    foreach ($items as $item) {
        ...
        foreach ($item['productList']  as $productList) {
            ...
            $productListOnPlaces = $stockService->getItemsForDiffReportByOrderIdOnlyBox($productList['inbound_id'], $productList['client_box_barcode'],$productList['product_barcode']);

//            \yii\helpers\VarDumper::dump($productListOnPlaces,10,true);
//            die;
