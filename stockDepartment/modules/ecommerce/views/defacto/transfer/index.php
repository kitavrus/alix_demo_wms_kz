...
<div class="row" style="margin: 20px 1px">
    <?= Html::tag('span', Yii::t('outbound/buttons', 'Содержимое нашего короба'), ['data-url' => Url::toRoute('show-box-items'), 'class' => 'btn btn-success', 'id' => 'transferform-show-box-items-bt', 'style' => 'margin-left:-10px;']) ?>
    <?= Html::tag('span', Yii::t('outbound/buttons', 'Содержимое LC короба'), ['data-url' => Url::toRoute('show-lc-box-items'), 'class' => 'btn btn-success', 'id' => 'transferform-show-lc-box-items-bt', 'style' => 'margin-left:10px;']) ?>
    <?= Html::tag('span', Yii::t('outbound/buttons', 'Отсканированные'), ['data-url' => Url::toRoute('show-scanned-items'), 'class' => 'btn btn-warning', 'id' => 'transferform-show-scanned-items-bt', 'style' => 'margin-left:10px;']) ?>
    <?= Html::tag('span', Yii::t('outbound/buttons', 'Содержимое заказа'), ['data-url' => Url::toRoute('show-order-items'), 'class' => 'btn btn-warning', 'id' => 'transferform-show-order-items-bt', 'style' => 'margin-left:10px;']) ?>
    <?= Html::tag('span', Yii::t('outbound/buttons', 'Clear Box'), ['data-url' => Url::toRoute('empty-box'), 'class' => 'btn btn-danger pull-right', 'id' => 'transferform-empty-box-bt', 'style' => 'margin-left:10px;']) ?>
</div>
