...
<div class="ecommerce-outbound-search">
    ...
    <table class="table" width="100%" cellspacing="10">
        ...
        <tr>
	        ...
	        <td width="10%">
                <?= $form->field($model, 'client_product_sku'); ?>
            </td>
            <td width="10%">
                <?= $form->field($model, 'status_availability')->dropDownList(\common\ecommerce\constants\StockAvailability::getConditionTypeArray(),['prompt' =>'Select...']); ?>
            </td>
            <td width="10%">
                <?= $form->field($model, 'status_outbound')->dropDownList(\common\ecommerce\constants\StockOutboundStatus::getAll(),['prompt' =>'Select...']); ?>
            </td>
        </tr>
    </table>
    ...
    <div class="form-group">
        ...
        <?= Html::a(Yii::t('buttons', 'Очистить поиск'), 'find-product-on-stock', ['class' => 'btn btn-warning']) ?>
    </div>
    <?php ActiveForm::end(); ?>
</div>