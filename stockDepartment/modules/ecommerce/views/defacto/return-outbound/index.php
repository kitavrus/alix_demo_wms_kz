...
<?= $form->field($model, 'returnReason')->dropDownList(\common\ecommerce\constants\ReturnReason::getAll(), ['prompt'=>''])->label(Yii::t('outbound/forms', 'Причина возврата Всего заказа')) ?>
...
<?= $form->field($model, 'returnProcess')->dropDownList(\common\ecommerce\constants\ReturnOutbound::getAll(), ['prompt'=>''])->label(Yii::t('outbound/forms', 'Товар бракованный?')) ?>
