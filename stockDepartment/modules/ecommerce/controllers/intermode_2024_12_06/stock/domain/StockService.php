<?php
namespace app\modules\ecommerce\controllers\intermode\stock\domain;


use app\modules\ecommerce\controllers\intermode\stock\domain\constants\StockAPIStatus;
...
class StockService
{
    ...
    {
        $this->repository = new \app\modules\ecommerce\controllers\intermode\stock\domain\repository\StockRepository();
		$this->api = new \app\modules\ecommerce\controllers\intermode\stock\domain\StockAPIService();
    }
