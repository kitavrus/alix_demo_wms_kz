...
namespace app\modules\ecommerce\controllers\intermode\stock\domain\repository;
...
//		$stock = EcommerceStock::find()->andWhere(['id'=>$stockId])->one();
		return EcommerceStock::find()->andWhere(['inbound_datamatrix_code'=>$datamatrix])->exists();
	}
