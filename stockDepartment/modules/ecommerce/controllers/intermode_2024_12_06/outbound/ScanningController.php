...
use app\modules\ecommerce\controllers\intermode\outbound\domain\OutboundForm;
use app\modules\ecommerce\controllers\intermode\outbound\domain\OutboundScanningService ;
use Yii;
...
//            die;
	...
	* */
    ...
    { // /ecommerce/intermode/outbound/scanning/package?id=430
		...
		return $this->redirect('/ecommerce/intermode/outbound/scanning/scanning-form');
    }
