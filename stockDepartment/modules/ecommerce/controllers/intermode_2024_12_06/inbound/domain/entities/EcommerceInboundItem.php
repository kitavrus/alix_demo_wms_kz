 ...
 * @property string $product_brand Бренд товара
 * @property string $product_color Цвет товара
 * @property string $product_model Артикул товара
...
class EcommerceInboundItem extends \common\models\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['product_name', 'product_brand', 'product_color', 'product_model'], 'string'],
        ];
    }
