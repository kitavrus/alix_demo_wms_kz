...
use common\ecommerce\entities\EcommerceTransferItemSearch;
use Yii;
use common\ecommerce\entities\EcommerceTransfer;
use common\ecommerce\entities\EcommerceTransferSearch;
...
class TransferReportController extends Controller
{
    ...
    {
        $searchModel = new EcommerceTransferSearch();
    ...
    {
        $searchModel = new EcommerceTransferItemSearch();
