...
use common\ecommerce\defacto\transfer\forms\TransferForm;
...
class TransferController extends Controller
{
    ...
    public function actionGetBatches()
    {
        ...
        return $this->redirect('/ecommerce/defacto/transfer/all-pick-list');
    }
    ...
    public function actionPrint($ids)
    {
        return $this->render('print/pick-list-pdf',[
            'outboundList'=>(new TransferService())->reservationOrdersForPrintPickingList([$ids])
        ]);
    }
    ...
    public function actionPickingListBarcode()
    {
        ...
        $returnForm = new TransferForm();
        $returnForm->setScenario(TransferForm::SCENARIO_PIKING_LIST_BARCODE);
    ...
    public function actionOurBoxBarcode()
    {
        ...
        $returnForm = new TransferForm();
        $returnForm->setScenario(TransferForm::SCENARIO_OUR_BOX_BARCODE);
    ...
    public function actionLcBarcode()
    {
        ...
        $returnForm = new TransferForm();
        $returnForm->setScenario(TransferForm::SCENARIO_LC_BOX_BARCODE);
    ...
    public function actionMoveAllProducts()
    {
        ...
        $returnForm = new TransferForm();
        $returnForm->setScenario(TransferForm::SCENARIO_MOVE_ALL_BOX_BARCODE);
    ...
    * */
    public function actionProductBarcode()
    {
        ...
        $returnForm = new TransferForm();
        $returnForm->setScenario(TransferForm::SCENARIO_PRODUCT_BARCODE);
    ...
    { // show-box-items
        ...
        $returnForm = new TransferForm();
        $returnForm->setScenario(TransferForm::SCENARIO_SHOW_BOX_ITEMS);
    ...
    { // show-lc-box-items
        ...
        $returnForm = new TransferForm();
        $returnForm->setScenario(TransferForm::SCENARIO_SHOW_LC_BOX_ITEMS);
    ...
    { // show-scanned-items
        ...
        $returnForm = new TransferForm();
        $returnForm->setScenario(TransferForm::SCENARIO_SHOW_SCANNED_ITEMS);
    ...
    { // show-picking-list-items
        ...
        $returnForm = new TransferForm();
        $returnForm->setScenario(TransferForm::SCENARIO_SHOW_ORDER_ITEMS);
    ...
    { // empty-box
        ...
        $returnForm = new TransferForm();
        $returnForm->setScenario(TransferForm::SCENARIO_EMPTY_BOX);
    ...
    { // complete
        ...
        $returnForm = new TransferForm();
        $returnForm->setScenario(TransferForm::SCENARIO_COMPLETE_ORDER);
