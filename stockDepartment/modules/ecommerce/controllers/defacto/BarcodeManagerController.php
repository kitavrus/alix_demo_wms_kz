...
use common\ecommerce\defacto\barcodeManager\forms\PrintBarcode;
use Yii;
use common\ecommerce\entities\EcommerceBarcodeManager;
use common\ecommerce\entities\EcommerceBarcodeManagerSerach;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * BarcodeManagerController implements the CRUD actions for EcommerceBarcodeManager model.
 */
class BarcodeManagerController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    * */
    public function actionPrintBarcodePdf($codebook_id,$qty)
    {
        return $this->render('_print_barcode',[
            'quantity'=>$qty,
            'model'=>\common\ecommerce\entities\EcommerceBarcodeManager::findOne($codebook_id),
        ]);
    }
}
